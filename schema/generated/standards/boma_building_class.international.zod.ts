// Generated from schema/generated/standards/boma_building_class.international.schema.json by tools/gen_zod.py. DO NOT EDIT.
...
/**
 * Stable PHDS wire codes for BOMA's displayed international labels.
 */
export const BomaInternationalCodeSchema = z.intersection(z.enum(["investment", "institutional", "speculative"]), z.string()).meta({description: "Stable PHDS wire codes for BOMA's displayed international labels.", title: "BomaInternationalCode"});

export type BomaInternationalCode = z.infer<typeof BomaInternationalCodeSchema>;

/**
 */
export const BomaInternationalSystemSchema = z.intersection(z.enum(["urn:phds:standard:boma:office:international"]), z.string()).meta({description: "", title: "BomaInternationalSystem"});

export type BomaInternationalSystem = z.infer<typeof BomaInternationalSystemSchema>;

/**
 * Subjective, market-relative office building classification using BOMA's international basis. This is not physical condition or construction quality.
 */
export const BomaInternationalOfficeMarketClassificationSchema = z.strictObject({"code": z.intersection(BomaInternationalCodeSchema, z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])"))), "description": z.string().nullable().optional(), "display": z.string().nullable().optional(), "scope": RatingScopeSchema.optional(), "system": z.intersection(BomaInternationalSystemSchema, z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")))}).meta({description: "Subjective, market-relative office building classification using BOMA's international basis. This is not physical condition or construction quality.", title: "BomaInternationalOfficeMarketClassification"});

export type BomaInternationalOfficeMarketClassification = z.infer<typeof BomaInternationalOfficeMarketClassificationSchema>;

/**
 */
export const BomaInternationalCommercialDetailsSchema = z.strictObject({"clear_height": z.union([LengthSchema, z.null()]).optional(), "dock_doors": z.number().int().nullable().optional(), "drive_in_doors": z.number().int().nullable().optional(), "elevators": z.number().int().nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "has_sprinkler": z.boolean().nullable().optional(), "market_classification": z.union([BomaInternationalOfficeMarketClassificationSchema, z.null()]).optional().meta({description: "Competitive market positioning under the named rating system; distinct from physical condition and construction quality."}), "occupancy_pct": z.number().min(0).max(100).nullable().optional().meta({description: "0–100 percentage points; 95 means 95 percent."}), "parking_ratio": z.union([UnitRateSchema, z.null()]).optional().meta({description: "e.g. spaces per 1000 sqft — denominator explicit"}), "parking_spaces": z.number().int().nullable().optional(), "parking_types": z.array(z.string()).nullable().optional().meta({description: "surface | structured | underground | covered | ..."}), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "submarket": z.string().nullable().optional().meta({description: "CRE market geography"}), "tenancy": z.string().nullable().optional().meta({description: "single_tenant | multi_tenant"}), "tenant_count": z.number().int().nullable().optional().meta({description: "Distinct legal tenants (not suites or leases); timing follows the containing Structure or StructureState context"})}).meta({description: "", title: "BomaInternationalCommercialDetails"});

export type BomaInternationalCommercialDetails = z.infer<typeof BomaInternationalCommercialDetailsSchema>;

/**
 */
export const BomaInternationalStructureStateSchema = z.strictObject({"areas": z.array(AreaMeasureSchema).nullable().optional().meta({description: "Long-tail area kinds; canonical kinds forbidden here (validator-enforced)"}), "basement_area": z.union([AreaSchema, z.null()]).optional(), "basement_finished_area": z.union([AreaSchema, z.null()]).optional(), "commercial": z.union([BomaInternationalCommercialDetailsSchema, z.null()]).optional(), "condition_ratings": z.array(RatingSchema).nullable().optional().meta({description: "Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair."}), "construction_method": z.string().nullable().optional().meta({description: "site_built | manufactured | modular | container | 3d_printed | ..."}), "construction_status": z.string().nullable().optional().meta({description: "complete | proposed | under_construction"}), "construction_type": z.string().nullable().optional(), "cooling_types": z.array(z.string()).nullable().optional(), "effective_year_built": z.number().int().nullable().optional(), "exterior_wall_type": z.string().nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "features": z.array(z.string()).nullable().optional().meta({description: "Open vocabulary for physical features and amenities"}), "foundation_material": z.string().nullable().optional(), "foundation_type": z.string().nullable().optional(), "garage_area": z.union([AreaSchema, z.null()]).optional(), "gross_area": z.union([AreaSchema, z.null()]).optional(), "ground_floor_area": z.union([AreaSchema, z.null()]).optional(), "heating_fuel_type": z.string().nullable().optional(), "heating_types": z.array(z.string()).nullable().optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "kind": z.string().nullable().optional().meta({description: "building | barn | silo | shed | outbuilding | ... (open)"}), "living_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Finished area intended for human habitation. The measurement method and treatment of above-grade and below-grade space come from the applicable profile or provenance."}), "name": z.string().nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "quality_ratings": z.array(RatingSchema).nullable().optional().meta({description: "Construction-quality ratings. Semantic validation permits at most one rating for each system and scope pair."}), "renovations": z.array(RenovationSchema).nullable().optional(), "rentable_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Area of occupiable premises allocated to a tenant or available for lease under the stated measurement method."}), "residential": z.union([ResidentialDetailsSchema, z.null()]).optional(), "roof_material_type": z.string().nullable().optional(), "roof_style_type": z.string().nullable().optional(), "sewer_type": z.string().nullable().optional(), "stories": z.number().nullable().optional(), "structure_number": z.string().nullable().optional(), "subject": z.string(), "unit_count": z.number().int().min(1).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional(), "water_type": z.string().nullable().optional(), "year_built": z.number().int().min(1).max(2200).nullable().optional(), "year_built_estimated": z.boolean().nullable().optional()}).meta({description: "", title: "BomaInternationalStructureState"});

export type BomaInternationalStructureState = z.infer<typeof BomaInternationalStructureStateSchema>;

/**
 */
export const BomaInternationalPropertyStateSnapshotSchema = z.strictObject({"as_of_date": z.iso.date(), "basis": z.union([CodeableConceptSchema, z.null()]).optional().meta({description: "at_sale | at_listing | at_lease | inspection | reported | inferred (open vocabulary)"}), "extras": z.union([AnySchema, z.null()]).optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "property": z.string(), "property_state": z.union([PropertyStateSchema, z.null()]).optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "site_states": z.array(SiteStateSchema).nullable().optional(), "space_states": z.array(SpaceStateSchema).nullable().optional(), "structure_states": z.array(BomaInternationalStructureStateSchema).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional()}).meta({description: "", title: "BomaInternationalPropertyStateSnapshot"});

export type BomaInternationalPropertyStateSnapshot = z.infer<typeof BomaInternationalPropertyStateSnapshotSchema>;

/**
 */
export const BomaInternationalStructureSchema = z.strictObject({"areas": z.array(AreaMeasureSchema).nullable().optional().meta({description: "Long-tail area kinds; canonical kinds forbidden here (validator-enforced)"}), "basement_area": z.union([AreaSchema, z.null()]).optional(), "basement_finished_area": z.union([AreaSchema, z.null()]).optional(), "commercial": z.union([BomaInternationalCommercialDetailsSchema, z.null()]).optional(), "condition_ratings": z.array(RatingSchema).nullable().optional().meta({description: "Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair."}), "construction_method": z.string().nullable().optional().meta({description: "site_built | manufactured | modular | container | 3d_printed | ..."}), "construction_status": z.string().nullable().optional().meta({description: "complete | proposed | under_construction"}), "construction_type": z.string().nullable().optional(), "cooling_types": z.array(z.string()).nullable().optional(), "effective_year_built": z.number().int().nullable().optional(), "exterior_wall_type": z.string().nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "features": z.array(z.string()).nullable().optional().meta({description: "Open vocabulary for physical features and amenities"}), "foundation_material": z.string().nullable().optional(), "foundation_type": z.string().nullable().optional(), "garage_area": z.union([AreaSchema, z.null()]).optional(), "gross_area": z.union([AreaSchema, z.null()]).optional(), "ground_floor_area": z.union([AreaSchema, z.null()]).optional(), "heating_fuel_type": z.string().nullable().optional(), "heating_types": z.array(z.string()).nullable().optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "kind": z.string().nullable().optional().meta({description: "building | barn | silo | shed | outbuilding | ... (open)"}), "living_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Finished area intended for human habitation. The measurement method and treatment of above-grade and below-grade space come from the applicable profile or provenance."}), "name": z.string().nullable().optional(), "property": z.string(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "quality_ratings": z.array(RatingSchema).nullable().optional().meta({description: "Construction-quality ratings. Semantic validation permits at most one rating for each system and scope pair."}), "renovations": z.array(RenovationSchema).nullable().optional(), "rentable_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Area of occupiable premises allocated to a tenant or available for lease under the stated measurement method."}), "residential": z.union([ResidentialDetailsSchema, z.null()]).optional(), "roof_material_type": z.string().nullable().optional(), "roof_style_type": z.string().nullable().optional(), "sewer_type": z.string().nullable().optional(), "stories": z.number().nullable().optional(), "structure_number": z.string().nullable().optional(), "unit_count": z.number().int().min(1).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional(), "water_type": z.string().nullable().optional(), "year_built": z.number().int().min(1).max(2200).nullable().optional(), "year_built_estimated": z.boolean().nullable().optional()}).meta({description: "", title: "BomaInternationalStructure"});

export type BomaInternationalStructure = z.infer<typeof BomaInternationalStructureSchema>;

/**
 * Optional BOMA international-basis office building class interchange document. Core PHDS does not depend on this profile.
 */
export const BomaInternationalBuildingClassPropertyProfileSchema = z.strictObject({"addresses": z.array(AddressSchema).nullable().optional().meta({description: "Address bundle referenced by property/parties/ownership"}), "artifacts": z.array(SourceArtifactSchema).nullable().optional(), "assessments": z.array(AssessmentSchema).nullable().optional(), "associations": z.array(PropertyAssociationSchema).nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "foreclosure_cases": z.array(ForeclosureCaseSchema).nullable().optional(), "identifiers": z.array(PropertyIdentifierSchema).nullable().optional(), "jurisdictions": z.array(JurisdictionSchema).nullable().optional(), "leases": z.array(LeaseEventSchema).nullable().optional(), "liens": z.array(LienSchema).nullable().optional(), "listings": z.array(ListingSchema).nullable().optional(), "loans": z.array(LoanSchema).nullable().optional(), "operating_statements": z.array(OperatingStatementSchema).nullable().optional(), "ownership": z.array(OwnershipPeriodSchema).nullable().optional(), "parcel_identifiers": z.array(ParcelIdentifierSchema).nullable().optional(), "parcel_lineage": z.array(ParcelLineageSchema).nullable().optional(), "parcels": z.array(ParcelSchema).nullable().optional(), "parties": z.array(PartySchema).nullable().optional(), "permits": z.array(PermitSchema).nullable().optional(), "property": PropertySchema, "property_addresses": z.array(PropertyAddressSchema).nullable().optional(), "property_parcels": z.array(PropertyParcelSchema).nullable().optional(), "property_state_snapshots": z.array(BomaInternationalPropertyStateSnapshotSchema).nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "rent_rolls": z.array(RentRollSchema).nullable().optional(), "sale_evidence": z.array(SaleEvidenceSchema).nullable().optional(), "sales": z.array(SaleEventSchema).nullable().optional(), "site": z.union([SiteSchema, z.null()]).optional(), "spaces": z.array(SpaceSchema).nullable().optional(), "structures": z.array(BomaInternationalStructureSchema).nullable().optional(), "tax_bills": z.array(TaxBillSchema).nullable().optional(), "transfers": z.array(TransferSchema).nullable().optional(), "unit_rents": z.array(UnitRentObservationSchema).nullable().optional(), "valuations": z.array(ValuationSchema).nullable().optional()}).meta({description: "Optional BOMA international-basis office building class interchange document. Core PHDS does not depend on this profile.", title: "BomaInternationalBuildingClassPropertyProfile"});

export type BomaInternationalBuildingClassPropertyProfile = z.infer<typeof BomaInternationalBuildingClassPropertyProfileSchema>;

/**
 * Optional BOMA international-basis office classification profile. Core PHDS does not depend on this profile.
 */
export const BomaInternationalPropertyProfileSchema = z.strictObject({"addresses": z.array(AddressSchema).nullable().optional().meta({description: "Address bundle referenced by property/parties/ownership"}), "artifacts": z.array(SourceArtifactSchema).nullable().optional(), "assessments": z.array(AssessmentSchema).nullable().optional(), "associations": z.array(PropertyAssociationSchema).nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "foreclosure_cases": z.array(ForeclosureCaseSchema).nullable().optional(), "identifiers": z.array(PropertyIdentifierSchema).nullable().optional(), "jurisdictions": z.array(JurisdictionSchema).nullable().optional(), "leases": z.array(LeaseEventSchema).nullable().optional(), "liens": z.array(LienSchema).nullable().optional(), "listings": z.array(ListingSchema).nullable().optional(), "loans": z.array(LoanSchema).nullable().optional(), "operating_statements": z.array(OperatingStatementSchema).nullable().optional(), "ownership": z.array(OwnershipPeriodSchema).nullable().optional(), "parcel_identifiers": z.array(ParcelIdentifierSchema).nullable().optional(), "parcel_lineage": z.array(ParcelLineageSchema).nullable().optional(), "parcels": z.array(ParcelSchema).nullable().optional(), "parties": z.array(PartySchema).nullable().optional(), "permits": z.array(PermitSchema).nullable().optional(), "property": PropertySchema, "property_addresses": z.array(PropertyAddressSchema).nullable().optional(), "property_parcels": z.array(PropertyParcelSchema).nullable().optional(), "property_state_snapshots": z.array(BomaInternationalPropertyStateSnapshotSchema).nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "rent_rolls": z.array(RentRollSchema).nullable().optional(), "sale_evidence": z.array(SaleEvidenceSchema).nullable().optional(), "sales": z.array(SaleEventSchema).nullable().optional(), "site": z.union([SiteSchema, z.null()]).optional(), "spaces": z.array(SpaceSchema).nullable().optional(), "structures": z.array(BomaInternationalStructureSchema).nullable().optional(), "tax_bills": z.array(TaxBillSchema).nullable().optional(), "transfers": z.array(TransferSchema).nullable().optional(), "unit_rents": z.array(UnitRentObservationSchema).nullable().optional(), "valuations": z.array(ValuationSchema).nullable().optional()}).meta({description: "Optional BOMA international-basis office classification profile. Core PHDS does not depend on this profile.", title: "BomaInternationalPropertyProfile"});

export type BomaInternationalPropertyProfile = z.infer<typeof BomaInternationalPropertyProfileSchema>;

/**
 */
export const BomaMetroCodeSchema = z.intersection(z.enum(["A", "B", "C"]), z.string()).meta({description: "", title: "BomaMetroCode"});

export type BomaMetroCode = z.infer<typeof BomaMetroCodeSchema>;

/**
 */
export const BomaMetroSystemSchema = z.intersection(z.enum(["urn:phds:standard:boma:office:metro"]), z.string()).meta({description: "", title: "BomaMetroSystem"});

export type BomaMetroSystem = z.infer<typeof BomaMetroSystemSchema>;

/**
 * Subjective, market-relative office building classification using BOMA's metropolitan-market basis. This is not physical condition or construction quality.
 */
export const BomaMetroOfficeMarketClassificationSchema = z.strictObject({"code": z.intersection(BomaMetroCodeSchema, z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])"))), "description": z.string().nullable().optional(), "display": z.string().nullable().optional(), "scope": RatingScopeSchema.optional(), "system": z.intersection(BomaMetroSystemSchema, z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")))}).meta({description: "Subjective, market-relative office building classification using BOMA's metropolitan-market basis. This is not physical condition or construction quality.", title: "BomaMetroOfficeMarketClassification"});

export type BomaMetroOfficeMarketClassification = z.infer<typeof BomaMetroOfficeMarketClassificationSchema>;

/**
 */
export const BomaMetroCommercialDetailsSchema = z.strictObject({"clear_height": z.union([LengthSchema, z.null()]).optional(), "dock_doors": z.number().int().nullable().optional(), "drive_in_doors": z.number().int().nullable().optional(), "elevators": z.number().int().nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "has_sprinkler": z.boolean().nullable().optional(), "market_classification": z.union([BomaMetroOfficeMarketClassificationSchema, z.null()]).optional().meta({description: "Competitive market positioning under the named rating system; distinct from physical condition and construction quality."}), "occupancy_pct": z.number().min(0).max(100).nullable().optional().meta({description: "0–100 percentage points; 95 means 95 percent."}), "parking_ratio": z.union([UnitRateSchema, z.null()]).optional().meta({description: "e.g. spaces per 1000 sqft — denominator explicit"}), "parking_spaces": z.number().int().nullable().optional(), "parking_types": z.array(z.string()).nullable().optional().meta({description: "surface | structured | underground | covered | ..."}), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "submarket": z.string().nullable().optional().meta({description: "CRE market geography"}), "tenancy": z.string().nullable().optional().meta({description: "single_tenant | multi_tenant"}), "tenant_count": z.number().int().nullable().optional().meta({description: "Distinct legal tenants (not suites or leases); timing follows the containing Structure or StructureState context"})}).meta({description: "", title: "BomaMetroCommercialDetails"});

export type BomaMetroCommercialDetails = z.infer<typeof BomaMetroCommercialDetailsSchema>;

/**
 */
export const BomaMetroStructureStateSchema = z.strictObject({"areas": z.array(AreaMeasureSchema).nullable().optional().meta({description: "Long-tail area kinds; canonical kinds forbidden here (validator-enforced)"}), "basement_area": z.union([AreaSchema, z.null()]).optional(), "basement_finished_area": z.union([AreaSchema, z.null()]).optional(), "commercial": z.union([BomaMetroCommercialDetailsSchema, z.null()]).optional(), "condition_ratings": z.array(RatingSchema).nullable().optional().meta({description: "Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair."}), "construction_method": z.string().nullable().optional().meta({description: "site_built | manufactured | modular | container | 3d_printed | ..."}), "construction_status": z.string().nullable().optional().meta({description: "complete | proposed | under_construction"}), "construction_type": z.string().nullable().optional(), "cooling_types": z.array(z.string()).nullable().optional(), "effective_year_built": z.number().int().nullable().optional(), "exterior_wall_type": z.string().nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "features": z.array(z.string()).nullable().optional().meta({description: "Open vocabulary for physical features and amenities"}), "foundation_material": z.string().nullable().optional(), "foundation_type": z.string().nullable().optional(), "garage_area": z.union([AreaSchema, z.null()]).optional(), "gross_area": z.union([AreaSchema, z.null()]).optional(), "ground_floor_area": z.union([AreaSchema, z.null()]).optional(), "heating_fuel_type": z.string().nullable().optional(), "heating_types": z.array(z.string()).nullable().optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "kind": z.string().nullable().optional().meta({description: "building | barn | silo | shed | outbuilding | ... (open)"}), "living_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Finished area intended for human habitation. The measurement method and treatment of above-grade and below-grade space come from the applicable profile or provenance."}), "name": z.string().nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "quality_ratings": z.array(RatingSchema).nullable().optional().meta({description: "Construction-quality ratings. Semantic validation permits at most one rating for each system and scope pair."}), "renovations": z.array(RenovationSchema).nullable().optional(), "rentable_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Area of occupiable premises allocated to a tenant or available for lease under the stated measurement method."}), "residential": z.union([ResidentialDetailsSchema, z.null()]).optional(), "roof_material_type": z.string().nullable().optional(), "roof_style_type": z.string().nullable().optional(), "sewer_type": z.string().nullable().optional(), "stories": z.number().nullable().optional(), "structure_number": z.string().nullable().optional(), "subject": z.string(), "unit_count": z.number().int().min(1).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional(), "water_type": z.string().nullable().optional(), "year_built": z.number().int().min(1).max(2200).nullable().optional(), "year_built_estimated": z.boolean().nullable().optional()}).meta({description: "", title: "BomaMetroStructureState"});

export type BomaMetroStructureState = z.infer<typeof BomaMetroStructureStateSchema>;

/**
 */
export const BomaMetroPropertyStateSnapshotSchema = z.strictObject({"as_of_date": z.iso.date(), "basis": z.union([CodeableConceptSchema, z.null()]).optional().meta({description: "at_sale | at_listing | at_lease | inspection | reported | inferred (open vocabulary)"}), "extras": z.union([AnySchema, z.null()]).optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "property": z.string(), "property_state": z.union([PropertyStateSchema, z.null()]).optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "site_states": z.array(SiteStateSchema).nullable().optional(), "space_states": z.array(SpaceStateSchema).nullable().optional(), "structure_states": z.array(BomaMetroStructureStateSchema).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional()}).meta({description: "", title: "BomaMetroPropertyStateSnapshot"});

export type BomaMetroPropertyStateSnapshot = z.infer<typeof BomaMetroPropertyStateSnapshotSchema>;

/**
 */
export const BomaMetroStructureSchema = z.strictObject({"areas": z.array(AreaMeasureSchema).nullable().optional().meta({description: "Long-tail area kinds; canonical kinds forbidden here (validator-enforced)"}), "basement_area": z.union([AreaSchema, z.null()]).optional(), "basement_finished_area": z.union([AreaSchema, z.null()]).optional(), "commercial": z.union([BomaMetroCommercialDetailsSchema, z.null()]).optional(), "condition_ratings": z.array(RatingSchema).nullable().optional().meta({description: "Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair."}), "construction_method": z.string().nullable().optional().meta({description: "site_built | manufactured | modular | container | 3d_printed | ..."}), "construction_status": z.string().nullable().optional().meta({description: "complete | proposed | under_construction"}), "construction_type": z.string().nullable().optional(), "cooling_types": z.array(z.string()).nullable().optional(), "effective_year_built": z.number().int().nullable().optional(), "exterior_wall_type": z.string().nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "features": z.array(z.string()).nullable().optional().meta({description: "Open vocabulary for physical features and amenities"}), "foundation_material": z.string().nullable().optional(), "foundation_type": z.string().nullable().optional(), "garage_area": z.union([AreaSchema, z.null()]).optional(), "gross_area": z.union([AreaSchema, z.null()]).optional(), "ground_floor_area": z.union([AreaSchema, z.null()]).optional(), "heating_fuel_type": z.string().nullable().optional(), "heating_types": z.array(z.string()).nullable().optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "kind": z.string().nullable().optional().meta({description: "building | barn | silo | shed | outbuilding | ... (open)"}), "living_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Finished area intended for human habitation. The measurement method and treatment of above-grade and below-grade space come from the applicable profile or provenance."}), "name": z.string().nullable().optional(), "property": z.string(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "quality_ratings": z.array(RatingSchema).nullable().optional().meta({description: "Construction-quality ratings. Semantic validation permits at most one rating for each system and scope pair."}), "renovations": z.array(RenovationSchema).nullable().optional(), "rentable_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Area of occupiable premises allocated to a tenant or available for lease under the stated measurement method."}), "residential": z.union([ResidentialDetailsSchema, z.null()]).optional(), "roof_material_type": z.string().nullable().optional(), "roof_style_type": z.string().nullable().optional(), "sewer_type": z.string().nullable().optional(), "stories": z.number().nullable().optional(), "structure_number": z.string().nullable().optional(), "unit_count": z.number().int().min(1).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional(), "water_type": z.string().nullable().optional(), "year_built": z.number().int().min(1).max(2200).nullable().optional(), "year_built_estimated": z.boolean().nullable().optional()}).meta({description: "", title: "BomaMetroStructure"});

export type BomaMetroStructure = z.infer<typeof BomaMetroStructureSchema>;

/**
 * Optional BOMA metropolitan-market office classification profile. Core PHDS does not depend on this profile.
 */
export const BomaMetroPropertyProfileSchema = z.strictObject({"addresses": z.array(AddressSchema).nullable().optional().meta({description: "Address bundle referenced by property/parties/ownership"}), "artifacts": z.array(SourceArtifactSchema).nullable().optional(), "assessments": z.array(AssessmentSchema).nullable().optional(), "associations": z.array(PropertyAssociationSchema).nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "foreclosure_cases": z.array(ForeclosureCaseSchema).nullable().optional(), "identifiers": z.array(PropertyIdentifierSchema).nullable().optional(), "jurisdictions": z.array(JurisdictionSchema).nullable().optional(), "leases": z.array(LeaseEventSchema).nullable().optional(), "liens": z.array(LienSchema).nullable().optional(), "listings": z.array(ListingSchema).nullable().optional(), "loans": z.array(LoanSchema).nullable().optional(), "operating_statements": z.array(OperatingStatementSchema).nullable().optional(), "ownership": z.array(OwnershipPeriodSchema).nullable().optional(), "parcel_identifiers": z.array(ParcelIdentifierSchema).nullable().optional(), "parcel_lineage": z.array(ParcelLineageSchema).nullable().optional(), "parcels": z.array(ParcelSchema).nullable().optional(), "parties": z.array(PartySchema).nullable().optional(), "permits": z.array(PermitSchema).nullable().optional(), "property": PropertySchema, "property_addresses": z.array(PropertyAddressSchema).nullable().optional(), "property_parcels": z.array(PropertyParcelSchema).nullable().optional(), "property_state_snapshots": z.array(BomaMetroPropertyStateSnapshotSchema).nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "rent_rolls": z.array(RentRollSchema).nullable().optional(), "sale_evidence": z.array(SaleEvidenceSchema).nullable().optional(), "sales": z.array(SaleEventSchema).nullable().optional(), "site": z.union([SiteSchema, z.null()]).optional(), "spaces": z.array(SpaceSchema).nullable().optional(), "structures": z.array(BomaMetroStructureSchema).nullable().optional(), "tax_bills": z.array(TaxBillSchema).nullable().optional(), "transfers": z.array(TransferSchema).nullable().optional(), "unit_rents": z.array(UnitRentObservationSchema).nullable().optional(), "valuations": z.array(ValuationSchema).nullable().optional()}).meta({description: "Optional BOMA metropolitan-market office classification profile. Core PHDS does not depend on this profile.", title: "BomaMetroPropertyProfile"});

export type BomaMetroPropertyProfile = z.infer<typeof BomaMetroPropertyProfileSchema>;
 ...
 * Optional BOMA international-basis office building class interchange document. Core PHDS does not depend on this profile.
 */
export const BomaInternationalSchema = z.looseObject({"addresses": z.array(AddressSchema).nullable().optional().meta({description: "Address bundle referenced by property/parties/ownership"}), "artifacts": z.array(SourceArtifactSchema).nullable().optional(), "assessments": z.array(AssessmentSchema).nullable().optional(), "associations": z.array(PropertyAssociationSchema).nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "foreclosure_cases": z.array(ForeclosureCaseSchema).nullable().optional(), "identifiers": z.array(PropertyIdentifierSchema).nullable().optional(), "jurisdictions": z.array(JurisdictionSchema).nullable().optional(), "leases": z.array(LeaseEventSchema).nullable().optional(), "liens": z.array(LienSchema).nullable().optional(), "listings": z.array(ListingSchema).nullable().optional(), "loans": z.array(LoanSchema).nullable().optional(), "operating_statements": z.array(OperatingStatementSchema).nullable().optional(), "ownership": z.array(OwnershipPeriodSchema).nullable().optional(), "parcel_identifiers": z.array(ParcelIdentifierSchema).nullable().optional(), "parcel_lineage": z.array(ParcelLineageSchema).nullable().optional(), "parcels": z.array(ParcelSchema).nullable().optional(), "parties": z.array(PartySchema).nullable().optional(), "permits": z.array(PermitSchema).nullable().optional(), "property": PropertySchema, "property_addresses": z.array(PropertyAddressSchema).nullable().optional(), "property_parcels": z.array(PropertyParcelSchema).nullable().optional(), "property_state_snapshots": z.array(BomaInternationalPropertyStateSnapshotSchema).nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "rent_rolls": z.array(RentRollSchema).nullable().optional(), "sale_evidence": z.array(SaleEvidenceSchema).nullable().optional(), "sales": z.array(SaleEventSchema).nullable().optional(), "site": z.union([SiteSchema, z.null()]).optional(), "spaces": z.array(SpaceSchema).nullable().optional(), "structures": z.array(BomaInternationalStructureSchema).nullable().optional(), "tax_bills": z.array(TaxBillSchema).nullable().optional(), "transfers": z.array(TransferSchema).nullable().optional(), "unit_rents": z.array(UnitRentObservationSchema).nullable().optional(), "valuations": z.array(ValuationSchema).nullable().optional()}).meta({$id: "https://example.org/phds/standards/boma-building-class/international", $schema: "https://json-schema.org/draft/2019-09/schema", description: "Optional BOMA international-basis office building class interchange document. Core PHDS does not depend on this profile.", metamodel_version: "1.11.0", title: "phds_boma_building_class_international", version: "0.2.0"});

export type BomaInternational = z.infer<typeof BomaInternationalSchema>;
