...
pub type market_classification = String;
pub type clear_height = String;
pub type dock_doors = String;
pub type drive_in_doors = String;
pub type occupancy_pct = String;
pub type parking_spaces = String;
pub type parking_ratio = String;
pub type tenancy = String;
pub type tenant_count = String;
pub type parking_types = String;
pub type has_sprinkler = String;
pub type elevators = String;
...
pub enum BomaMetroSystem {
#[cfg_attr(feature = "serde", serde(rename = "urn:phds:standard:boma:office:metro"))]
    UrnPhdsStandardBomaOfficeMetro,
}

impl core::fmt::Display for BomaMetroSystem {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            BomaMetroSystem::UrnPhdsStandardBomaOfficeMetro => f.write_str("urn:phds:standard:boma:office:metro"),
        }
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for BomaMetroSystem {
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        let s: &str = match self {
            BomaMetroSystem::UrnPhdsStandardBomaOfficeMetro => "urn:phds:standard:boma:office:metro",
        };
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for BomaMetroSystem {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(s) = ob.extract::<&str>() {
            match s {
                "urn:phds:standard:boma:office:metro" | "UrnPhdsStandardBomaOfficeMetro" => Ok(BomaMetroSystem::UrnPhdsStandardBomaOfficeMetro),
                _ => Err(PyErr::new::<pyo3::exceptions::PyValueError, _>(
                    format!("invalid value for BomaMetroSystem: {}", s),
                )),
            }
        } else {
            Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                concat!("expected str for ", stringify!(BomaMetroSystem)),
            ))
        }
    }
}
...
#[cfg(feature = "stubgen")]
impl ::pyo3_stub_gen::PyStubType for BomaMetroSystem {
    fn type_output() -> ::pyo3_stub_gen::TypeInfo {
        ::pyo3_stub_gen::TypeInfo::with_module(
            "typing.Literal['urn:phds:standard:boma:office:metro']",
            "typing".into(),
        )
    }
}
#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
pub enum BomaInternationalSystem {
#[cfg_attr(feature = "serde", serde(rename = "urn:phds:standard:boma:office:international"))]
    UrnPhdsStandardBomaOfficeInternational,
}

impl core::fmt::Display for BomaInternationalSystem {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            BomaInternationalSystem::UrnPhdsStandardBomaOfficeInternational => f.write_str("urn:phds:standard:boma:office:international"),
        }
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for BomaInternationalSystem {
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        let s: &str = match self {
            BomaInternationalSystem::UrnPhdsStandardBomaOfficeInternational => "urn:phds:standard:boma:office:international",
        };
        Ok(pyo3::types::PyString::new(py, s).into_any())
    }
}
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for BomaInternationalSystem {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(s) = ob.extract::<&str>() {
            match s {
                "urn:phds:standard:boma:office:international" | "UrnPhdsStandardBomaOfficeInternational" => Ok(BomaInternationalSystem::UrnPhdsStandardBomaOfficeInternational),
                _ => Err(PyErr::new::<pyo3::exceptions::PyValueError, _>(
                    format!("invalid value for BomaInternationalSystem: {}", s),
                )),
            }
        } else {
            Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                concat!("expected str for ", stringify!(BomaInternationalSystem)),
            ))
        }
    }
}
...
#[cfg(feature = "stubgen")]
impl ::pyo3_stub_gen::PyStubType for BomaInternationalSystem {
    fn type_output() -> ::pyo3_stub_gen::TypeInfo {
        ::pyo3_stub_gen::TypeInfo::with_module(
            "typing.Literal['urn:phds:standard:boma:office:international']",
            "typing".into(),
        )
    }
}
...
impl core::fmt::Display for BomaMetroCode {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            BomaMetroCode::A => f.write_str("A"),
            BomaMetroCode::B => f.write_str("B"),
            BomaMetroCode::C => f.write_str("C"),
        }
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for BomaMetroCode {
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for BomaMetroCode {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(s) = ob.extract::<&str>() {
            match s {
                "A" => Ok(BomaMetroCode::A),
                "B" => Ok(BomaMetroCode::B),
                "C" => Ok(BomaMetroCode::C),
                _ => Err(PyErr::new::<pyo3::exceptions::PyValueError, _>(
                    format!("invalid value for BomaMetroCode: {}", s),
                )),
            }
        } else {
            Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                concat!("expected str for ", stringify!(BomaMetroCode)),
            ))
        }
    }
}
...
#[cfg(feature = "stubgen")]
impl ::pyo3_stub_gen::PyStubType for BomaMetroCode {
    fn type_output() -> ::pyo3_stub_gen::TypeInfo {
        ::pyo3_stub_gen::TypeInfo::with_module(
...
#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
pub enum BomaInternationalCode {
#[cfg_attr(feature = "serde", serde(rename = "investment"))]
    Investment,
#[cfg_attr(feature = "serde", serde(rename = "institutional"))]
    Institutional,
#[cfg_attr(feature = "serde", serde(rename = "speculative"))]
    Speculative,
}

impl core::fmt::Display for BomaInternationalCode {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            BomaInternationalCode::Investment => f.write_str("investment"),
            BomaInternationalCode::Institutional => f.write_str("institutional"),
            BomaInternationalCode::Speculative => f.write_str("speculative"),
        }
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for BomaInternationalCode {
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        let s: &str = match self {
            BomaInternationalCode::Investment => "investment",
            BomaInternationalCode::Institutional => "institutional",
            BomaInternationalCode::Speculative => "speculative",
        };
        Ok(pyo3::types::PyString::new(py, s).into_any())
    }
}
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for BomaInternationalCode {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(s) = ob.extract::<&str>() {
            match s {
                "investment" | "Investment" => Ok(BomaInternationalCode::Investment),
                "institutional" | "Institutional" => Ok(BomaInternationalCode::Institutional),
                "speculative" | "Speculative" => Ok(BomaInternationalCode::Speculative),
                _ => Err(PyErr::new::<pyo3::exceptions::PyValueError, _>(
                    format!("invalid value for BomaInternationalCode: {}", s),
                )),
            }
        } else {
            Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                concat!("expected str for ", stringify!(BomaInternationalCode)),
            ))
        }
    }
}
...
#[cfg(feature = "stubgen")]
impl ::pyo3_stub_gen::PyStubType for BomaInternationalCode {
    fn type_output() -> ::pyo3_stub_gen::TypeInfo {
        ::pyo3_stub_gen::TypeInfo::with_module(
            "typing.Literal['investment', 'institutional', 'speculative']",
            "typing".into(),
        )
    }
}
...
pub mod codeable_concept_utl {
    ...
    pub enum system_range {
        String(String),
        BomaMetroSystem(BomaMetroSystem),
        BomaInternationalSystem(BomaInternationalSystem)    }
    ...
    impl<'py> FromPyObject<'py> for system_range {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            ...
            }            if let Ok(val) = ob.extract::<BomaMetroSystem>() {
                return Ok(system_range::BomaMetroSystem(val));
            }            if let Ok(val) = ob.extract::<BomaInternationalSystem>() {
                return Ok(system_range::BomaInternationalSystem(val));
            }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                "invalid system",
            ))
        }
    ...
    impl<'py> IntoPyObject<'py> for system_range {
        ...
        fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
            match self {
                ...
                system_range::BomaMetroSystem(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                system_range::BomaInternationalSystem(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
            }
        }
    }
    ...
    #[cfg(feature = "stubgen")]
    ::pyo3_stub_gen::impl_stub_type!(system_range = String | BomaMetroSystem | BomaInternationalSystem);
    #[derive(Debug, Clone, PartialEq)]
    #[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
    pub enum code_range {
        String(String),
        BomaMetroCode(BomaMetroCode),
        BomaInternationalCode(BomaInternationalCode)    }
    ...
    impl<'py> FromPyObject<'py> for code_range {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            ...
            }            if let Ok(val) = ob.extract::<BomaMetroCode>() {
                return Ok(code_range::BomaMetroCode(val));
            }            if let Ok(val) = ob.extract::<BomaInternationalCode>() {
                return Ok(code_range::BomaInternationalCode(val));
            }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                "invalid code",
            ))
        }
    ...
    impl<'py> IntoPyObject<'py> for code_range {
        ...
        fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
            match self {
                ...
                code_range::BomaMetroCode(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                code_range::BomaInternationalCode(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
            }
        }
    }
    ...
    #[cfg(feature = "stubgen")]
    ::pyo3_stub_gen::impl_stub_type!(code_range = String | BomaMetroCode | BomaInternationalCode);
}
...
pub enum CodeableConceptOrSubtype {    Classification(Classification),     Rating(Rating),     BomaMetroOfficeMarketClassification(BomaMetroOfficeMarketClassification),     BomaInternationalOfficeMarketClassification(BomaInternationalOfficeMarketClassification),     CodeableConcept(CodeableConcept)}
...
impl From<BomaMetroOfficeMarketClassification>   for CodeableConceptOrSubtype { fn from(x: BomaMetroOfficeMarketClassification)   -> Self { Self::BomaMetroOfficeMarketClassification(x) } }
impl From<BomaInternationalOfficeMarketClassification>   for CodeableConceptOrSubtype { fn from(x: BomaInternationalOfficeMarketClassification)   -> Self { Self::BomaInternationalOfficeMarketClassification(x) } }
...
impl<'py> FromPyObject<'py> for CodeableConceptOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        ...
        }        if let Ok(val) = ob.extract::<BomaMetroOfficeMarketClassification>() {
            return Ok(CodeableConceptOrSubtype::BomaMetroOfficeMarketClassification(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalOfficeMarketClassification>() {
            return Ok(CodeableConceptOrSubtype::BomaInternationalOfficeMarketClassification(val));
        }        if let Ok(val) = ob.extract::<CodeableConcept>() {
...
impl<'py> IntoPyObject<'py> for CodeableConceptOrSubtype {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            ...
            CodeableConceptOrSubtype::BomaMetroOfficeMarketClassification(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            CodeableConceptOrSubtype::BomaInternationalOfficeMarketClassification(val) => val.into_pyobject(py).map(move |b| b.into_any()),
...
#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(CodeableConceptOrSubtype = Classification | Rating | BomaMetroOfficeMarketClassification | BomaInternationalOfficeMarketClassification | CodeableConcept);
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature="serde", serde(untagged))]
pub enum RatingOrSubtype {    BomaMetroOfficeMarketClassification(BomaMetroOfficeMarketClassification),     BomaInternationalOfficeMarketClassification(BomaInternationalOfficeMarketClassification)}

impl From<BomaMetroOfficeMarketClassification>   for RatingOrSubtype { fn from(x: BomaMetroOfficeMarketClassification)   -> Self { Self::BomaMetroOfficeMarketClassification(x) } }
impl From<BomaInternationalOfficeMarketClassification>   for RatingOrSubtype { fn from(x: BomaInternationalOfficeMarketClassification)   -> Self { Self::BomaInternationalOfficeMarketClassification(x) } }

#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for RatingOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroOfficeMarketClassification>() {
            return Ok(RatingOrSubtype::BomaMetroOfficeMarketClassification(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalOfficeMarketClassification>() {
            return Ok(RatingOrSubtype::BomaInternationalOfficeMarketClassification(val));
        }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
...
impl<'py> IntoPyObject<'py> for RatingOrSubtype {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            RatingOrSubtype::BomaMetroOfficeMarketClassification(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            RatingOrSubtype::BomaInternationalOfficeMarketClassification(val) => val.into_pyobject(py).map(move |b| b.into_any()),
        }
    }
}
...
#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(RatingOrSubtype = BomaMetroOfficeMarketClassification | BomaInternationalOfficeMarketClassification);
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaMetroOfficeMarketClassification {
    pub system: BomaMetroSystem,
    pub code: BomaMetroCode,
    #[cfg_attr(feature = "serde", serde(default))]
    pub description: Option<String>,
    #[cfg_attr(feature = "serde", serde(default))]
    pub scope: Option<RatingScope>,
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaMetroOfficeMarketClassification {
    #[new]
    #[pyo3(signature = (system, code, description=None, scope=None, display=None))]
    pub fn new(system: BomaMetroSystem, code: BomaMetroCode, description: Option<String>, scope: Option<RatingScope>, display: Option<String>) -> Self {
        BomaMetroOfficeMarketClassification{system, code, description, scope, display}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaMetroOfficeMarketClassification>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaMetroOfficeMarketClassification> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroOfficeMarketClassification>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaMetroOfficeMarketClassification",
        ))
    }
}
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaInternationalOfficeMarketClassification {
    pub system: BomaInternationalSystem,
    pub code: BomaInternationalCode,
    #[cfg_attr(feature = "serde", serde(default))]
    pub description: Option<String>,
    #[cfg_attr(feature = "serde", serde(default))]
    pub scope: Option<RatingScope>,
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaInternationalOfficeMarketClassification {
    #[new]
    #[pyo3(signature = (system, code, description=None, scope=None, display=None))]
    pub fn new(system: BomaInternationalSystem, code: BomaInternationalCode, description: Option<String>, scope: Option<RatingScope>, display: Option<String>) -> Self {
        BomaInternationalOfficeMarketClassification{system, code, description, scope, display}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaInternationalOfficeMarketClassification>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaInternationalOfficeMarketClassification> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaInternationalOfficeMarketClassification>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaInternationalOfficeMarketClassification",
        ))
    }
}
...
impl From<BomaMetroPropertyStateSnapshot>   for EntityOrSubtype { fn from(x: BomaMetroPropertyStateSnapshot)   -> Self { Self::BomaMetroPropertyStateSnapshot(x) } }
impl From<BomaInternationalPropertyStateSnapshot>   for EntityOrSubtype { fn from(x: BomaInternationalPropertyStateSnapshot)   -> Self { Self::BomaInternationalPropertyStateSnapshot(x) } }
impl From<BomaMetroStructureState>   for EntityOrSubtype { fn from(x: BomaMetroStructureState)   -> Self { Self::BomaMetroStructureState(x) } }
impl From<BomaInternationalStructureState>   for EntityOrSubtype { fn from(x: BomaInternationalStructureState)   -> Self { Self::BomaInternationalStructureState(x) } }
impl From<BomaMetroStructure>   for EntityOrSubtype { fn from(x: BomaMetroStructure)   -> Self { Self::BomaMetroStructure(x) } }
impl From<BomaInternationalStructure>   for EntityOrSubtype { fn from(x: BomaInternationalStructure)   -> Self { Self::BomaInternationalStructure(x) } }
...
impl<'py> FromPyObject<'py> for EntityOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        ...
        }        if let Ok(val) = ob.extract::<BomaMetroPropertyStateSnapshot>() {
            return Ok(EntityOrSubtype::BomaMetroPropertyStateSnapshot(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalPropertyStateSnapshot>() {
            return Ok(EntityOrSubtype::BomaInternationalPropertyStateSnapshot(val));
        }        if let Ok(val) = ob.extract::<BomaMetroStructureState>() {
            return Ok(EntityOrSubtype::BomaMetroStructureState(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalStructureState>() {
            return Ok(EntityOrSubtype::BomaInternationalStructureState(val));
        }        if let Ok(val) = ob.extract::<BomaMetroStructure>() {
            return Ok(EntityOrSubtype::BomaMetroStructure(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalStructure>() {
            return Ok(EntityOrSubtype::BomaInternationalStructure(val));
        }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
...
impl<'py> IntoPyObject<'py> for EntityOrSubtype {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            ...
            EntityOrSubtype::BomaMetroPropertyStateSnapshot(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            EntityOrSubtype::BomaInternationalPropertyStateSnapshot(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            EntityOrSubtype::BomaMetroStructureState(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            EntityOrSubtype::BomaInternationalStructureState(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            EntityOrSubtype::BomaMetroStructure(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            EntityOrSubtype::BomaInternationalStructure(val) => val.into_pyobject(py).map(move |b| b.into_any()),
        }
    }
}
...
impl serde_utils::InlinedPair for EntityOrSubtype {
    ...
    fn from_pair_mapping(k: Self::Key, v: Self::Value) -> Result<Self, Self::Error> {
        ...
        if let Ok(x) = BomaMetroPropertyStateSnapshot::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaMetroPropertyStateSnapshot(x));
        }
        if let Ok(x) = BomaInternationalPropertyStateSnapshot::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaInternationalPropertyStateSnapshot(x));
        }
        if let Ok(x) = BomaMetroStructureState::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaMetroStructureState(x));
        }
        if let Ok(x) = BomaInternationalStructureState::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaInternationalStructureState(x));
        }
        if let Ok(x) = BomaMetroStructure::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaMetroStructure(x));
        }
        if let Ok(x) = BomaInternationalStructure::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaInternationalStructure(x));
        }
    ...
    fn from_pair_simple(k: Self::Key, v: Self::Value) -> Result<Self, Self::Error> {
        ...
        if let Ok(x) = BomaMetroPropertyStateSnapshot::from_pair_simple(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaMetroPropertyStateSnapshot(x));
        }
        if let Ok(x) = BomaInternationalPropertyStateSnapshot::from_pair_simple(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaInternationalPropertyStateSnapshot(x));
        }
        if let Ok(x) = BomaMetroStructureState::from_pair_simple(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaMetroStructureState(x));
        }
        if let Ok(x) = BomaInternationalStructureState::from_pair_simple(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaInternationalStructureState(x));
        }
        if let Ok(x) = BomaMetroStructure::from_pair_simple(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaMetroStructure(x));
        }
        if let Ok(x) = BomaInternationalStructure::from_pair_simple(k.clone(), v.clone()) {
            return Ok(EntityOrSubtype::BomaInternationalStructure(x));
        }
    ...
    fn extract_key(&self) -> &Self::Key {
        match self {
            ...
            EntityOrSubtype::BomaMetroPropertyStateSnapshot(inner) => inner.extract_key(),
            EntityOrSubtype::BomaInternationalPropertyStateSnapshot(inner) => inner.extract_key(),
            EntityOrSubtype::BomaMetroStructureState(inner) => inner.extract_key(),
            EntityOrSubtype::BomaInternationalStructureState(inner) => inner.extract_key(),
            EntityOrSubtype::BomaMetroStructure(inner) => inner.extract_key(),
            EntityOrSubtype::BomaInternationalStructure(inner) => inner.extract_key(),
        }
    }
}

#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(EntityOrSubtype = Jurisdiction | Address | Property | Parcel | PropertyParcel | ParcelLineage | PropertyIdentifier | Party | SourceArtifact | PropertyAddress | OwnershipPeriod | Structure | Site | Space | PropertyState | SiteState | StructureState | SpaceState | PropertyStateSnapshot | PropertyAssociation | Assessment | TaxBill | Transfer | SaleEvent | Listing | LeaseEvent | UnitRentObservation | Loan | Lien | ForeclosureCase | Permit | OperatingStatement | RentRoll | Valuation | BomaMetroPropertyStateSnapshot | BomaInternationalPropertyStateSnapshot | BomaMetroStructureState | BomaInternationalStructureState | BomaMetroStructure | BomaInternationalStructure);
...
pub mod structure_facts_utl {
    ...
    #[derive(Debug, Clone, PartialEq)]
    #[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
    pub enum commercial_range {
        CommercialDetails(CommercialDetails),
        BomaMetroCommercialDetails(BomaMetroCommercialDetails),
        BomaInternationalCommercialDetails(BomaInternationalCommercialDetails)    }

    #[cfg(feature = "pyo3")]
    impl<'py> FromPyObject<'py> for commercial_range {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            if let Ok(val) = ob.extract::<CommercialDetails>() {
                return Ok(commercial_range::CommercialDetails(val));
            }            if let Ok(val) = ob.extract::<BomaMetroCommercialDetails>() {
                return Ok(commercial_range::BomaMetroCommercialDetails(val));
            }            if let Ok(val) = ob.extract::<BomaInternationalCommercialDetails>() {
                return Ok(commercial_range::BomaInternationalCommercialDetails(val));
            }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                "invalid commercial",
            ))
        }
    ...
    #[cfg(feature = "pyo3")]
    impl<'py> IntoPyObject<'py> for commercial_range {
        type Target = PyAny;
        type Output = Bound<'py, Self::Target>;
        type Error = PyErr;
        ...
        fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
            match self {
                commercial_range::CommercialDetails(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                commercial_range::BomaMetroCommercialDetails(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                commercial_range::BomaInternationalCommercialDetails(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
            }
        }
    }
    ...
    #[cfg(feature = "pyo3")]
    impl<'py> IntoPyObject<'py> for Box<commercial_range>
    {
        type Target = PyAny;
        type Output = Bound<'py, Self::Target>;
        type Error = PyErr;
    ...
    #[cfg(feature = "pyo3")]
    impl<'py> FromPyObject<'py> for Box<commercial_range> {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            if let Ok(val) = ob.extract::<commercial_range>() {
                return Ok(Box::new(val));
            }
            Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                "invalid commercial",
    ...
    #[cfg(feature = "stubgen")]
    ::pyo3_stub_gen::impl_stub_type!(commercial_range = CommercialDetails | BomaMetroCommercialDetails | BomaInternationalCommercialDetails);
}
...
pub struct StructureFacts {
    ...
    #[cfg_attr(feature = "serde", serde(default))]
    pub commercial: Option<CommercialDetailsOrSubtype>,
    #[cfg_attr(feature = "serde", serde(default))]
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature="serde", serde(untagged))]
pub enum StructureFactsOrSubtype {    Structure(Structure),     StructureState(StructureState),     BomaMetroStructureState(BomaMetroStructureState),     BomaInternationalStructureState(BomaInternationalStructureState),     BomaMetroStructure(BomaMetroStructure),     BomaInternationalStructure(BomaInternationalStructure)}
...
impl From<BomaMetroStructureState>   for StructureFactsOrSubtype { fn from(x: BomaMetroStructureState)   -> Self { Self::BomaMetroStructureState(x) } }
impl From<BomaInternationalStructureState>   for StructureFactsOrSubtype { fn from(x: BomaInternationalStructureState)   -> Self { Self::BomaInternationalStructureState(x) } }
impl From<BomaMetroStructure>   for StructureFactsOrSubtype { fn from(x: BomaMetroStructure)   -> Self { Self::BomaMetroStructure(x) } }
impl From<BomaInternationalStructure>   for StructureFactsOrSubtype { fn from(x: BomaInternationalStructure)   -> Self { Self::BomaInternationalStructure(x) } }
...
impl<'py> FromPyObject<'py> for StructureFactsOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<Structure>() {
            ...
            return Ok(StructureFactsOrSubtype::BomaMetroStructureState(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalStructureState>() {
            return Ok(StructureFactsOrSubtype::BomaInternationalStructureState(val));
        }        if let Ok(val) = ob.extract::<BomaMetroStructure>() {
            return Ok(StructureFactsOrSubtype::BomaMetroStructure(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalStructure>() {
            return Ok(StructureFactsOrSubtype::BomaInternationalStructure(val));
        }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
...
impl<'py> IntoPyObject<'py> for StructureFactsOrSubtype {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            ...
            StructureFactsOrSubtype::BomaMetroStructureState(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            StructureFactsOrSubtype::BomaInternationalStructureState(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            StructureFactsOrSubtype::BomaMetroStructure(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            StructureFactsOrSubtype::BomaInternationalStructure(val) => val.into_pyobject(py).map(move |b| b.into_any()),
        }
    }
}
...
#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(StructureFactsOrSubtype = Structure | StructureState | BomaMetroStructureState | BomaInternationalStructureState | BomaMetroStructure | BomaInternationalStructure);
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature="serde", serde(untagged))]
pub enum StructureOrSubtype {    BomaMetroStructure(BomaMetroStructure),     BomaInternationalStructure(BomaInternationalStructure)}

impl From<BomaMetroStructure>   for StructureOrSubtype { fn from(x: BomaMetroStructure)   -> Self { Self::BomaMetroStructure(x) } }
impl From<BomaInternationalStructure>   for StructureOrSubtype { fn from(x: BomaInternationalStructure)   -> Self { Self::BomaInternationalStructure(x) } }

#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for StructureOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroStructure>() {
            return Ok(StructureOrSubtype::BomaMetroStructure(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalStructure>() {
            return Ok(StructureOrSubtype::BomaInternationalStructure(val));
        }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
...
impl<'py> IntoPyObject<'py> for StructureOrSubtype {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            StructureOrSubtype::BomaMetroStructure(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            StructureOrSubtype::BomaInternationalStructure(val) => val.into_pyobject(py).map(move |b| b.into_any()),
        }
    }
}
...
impl serde_utils::InlinedPair for StructureOrSubtype {
    ...
    fn from_pair_mapping(k: Self::Key, v: Self::Value) -> Result<Self, Self::Error> {
        if let Ok(x) = BomaMetroStructure::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(StructureOrSubtype::BomaMetroStructure(x));
        }
        if let Ok(x) = BomaInternationalStructure::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(StructureOrSubtype::BomaInternationalStructure(x));
        }
        Err("none of the variants matched the mapping form".into())
    }
    ...
    fn extract_key(&self) -> &Self::Key {
        match self {
            StructureOrSubtype::BomaMetroStructure(inner) => inner.extract_key(),
            StructureOrSubtype::BomaInternationalStructure(inner) => inner.extract_key(),
        }
    }
}

#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(StructureOrSubtype = BomaMetroStructure | BomaInternationalStructure);
...
pub struct BomaMetroStructure {
    ...
    pub residential: Option<ResidentialDetails>,
    #[cfg_attr(feature = "serde", serde(default))]
    pub commercial: Option<BomaMetroCommercialDetails>,
    #[cfg_attr(feature = "serde", serde(default))]
    pub renovations: Option<Vec<Renovation>>,
    #[cfg_attr(feature = "serde", serde(deserialize_with = "serde_utils::deserialize_nonblank_trimmed_string"))]
    pub id: String,
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaMetroStructure {
    #[new]
    #[pyo3(signature = (property, id, kind=None, name=None, structure_number=None, living_area=None, gross_area=None, rentable_area=None, ground_floor_area=None, basement_area=None, basement_finished_area=None, garage_area=None, areas=None, year_built=None, year_built_estimated=None, effective_year_built=None, stories=None, unit_count=None, construction_method=None, construction_status=None, construction_type=None, exterior_wall_type=None, roof_material_type=None, roof_style_type=None, foundation_type=None, foundation_material=None, condition_ratings=None, quality_ratings=None, heating_types=None, heating_fuel_type=None, cooling_types=None, sewer_type=None, water_type=None, features=None, residential=None, commercial=None, renovations=None, extras=None, provenance=None, verifications=None))]
    pub fn new(property: String, id: String, kind: Option<String>, name: Option<String>, structure_number: Option<String>, living_area: Option<serde_utils::PyValue<Area>>, gross_area: Option<serde_utils::PyValue<Area>>, rentable_area: Option<serde_utils::PyValue<Area>>, ground_floor_area: Option<serde_utils::PyValue<Area>>, basement_area: Option<serde_utils::PyValue<Area>>, basement_finished_area: Option<serde_utils::PyValue<Area>>, garage_area: Option<serde_utils::PyValue<Area>>, areas: Option<serde_utils::PyValue<Vec<AreaMeasure>>>, year_built: Option<isize>, year_built_estimated: Option<bool>, effective_year_built: Option<isize>, stories: Option<f64>, unit_count: Option<isize>, construction_method: Option<String>, construction_status: Option<String>, construction_type: Option<String>, exterior_wall_type: Option<String>, roof_material_type: Option<String>, roof_style_type: Option<String>, foundation_type: Option<String>, foundation_material: Option<String>, condition_ratings: Option<serde_utils::PyValue<Vec<RatingOrSubtype>>>, quality_ratings: Option<serde_utils::PyValue<Vec<RatingOrSubtype>>>, heating_types: Option<Vec<String>>, heating_fuel_type: Option<String>, cooling_types: Option<Vec<String>>, sewer_type: Option<String>, water_type: Option<String>, features: Option<Vec<String>>, residential: Option<serde_utils::PyValue<ResidentialDetails>>, commercial: Option<serde_utils::PyValue<BomaMetroCommercialDetails>>, renovations: Option<serde_utils::PyValue<Vec<Renovation>>>, extras: Option<serde_utils::PyValue<Any>>, provenance: Option<serde_utils::PyValue<Provenance>>, verifications: Option<serde_utils::PyValue<Vec<VerificationAttribution>>>) -> Self {
        let living_area = living_area.map(|v| v.into_inner());
        let gross_area = gross_area.map(|v| v.into_inner());
        let rentable_area = rentable_area.map(|v| v.into_inner());
        let ground_floor_area = ground_floor_area.map(|v| v.into_inner());
        ...
        let provenance = provenance.map(|v| v.into_inner());
        let verifications = verifications.map(|v| v.into_inner());
        BomaMetroStructure{property, id, kind, name, structure_number, living_area, gross_area, rentable_area, ground_floor_area, basement_area, basement_finished_area, garage_area, areas, year_built, year_built_estimated, effective_year_built, stories, unit_count, construction_method, construction_status, construction_type, exterior_wall_type, roof_material_type, roof_style_type, foundation_type, foundation_material, condition_ratings, quality_ratings, heating_types, heating_fuel_type, cooling_types, sewer_type, water_type, features, residential, commercial, renovations, extras, provenance, verifications}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaMetroStructure>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaMetroStructure> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroStructure>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaMetroStructure",
        ))
    }
}
...
#[cfg(feature = "serde")]
impl serde_utils::InlinedPair for BomaMetroStructure {
    type Key   = String;
    type Value = Value;
    type Error = String;
    ...
    fn from_pair_simple(_k: Self::Key, _v: Value) -> Result<Self,Self::Error> {
        Err("Cannot create a BomaMetroStructure from a primitive value!".into())
    }
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaInternationalStructure {
    pub property: String,
    #[cfg_attr(feature = "serde", serde(default))]
    pub kind: Option<String>,
    #[cfg_attr(feature = "serde", serde(default))]
    ...
    pub residential: Option<ResidentialDetails>,
    #[cfg_attr(feature = "serde", serde(default))]
    pub commercial: Option<BomaInternationalCommercialDetails>,
    #[cfg_attr(feature = "serde", serde(default))]
    pub renovations: Option<Vec<Renovation>>,
    #[cfg_attr(feature = "serde", serde(deserialize_with = "serde_utils::deserialize_nonblank_trimmed_string"))]
    pub id: String,
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaInternationalStructure {
    #[new]
    #[pyo3(signature = (property, id, kind=None, name=None, structure_number=None, living_area=None, gross_area=None, rentable_area=None, ground_floor_area=None, basement_area=None, basement_finished_area=None, garage_area=None, areas=None, year_built=None, year_built_estimated=None, effective_year_built=None, stories=None, unit_count=None, construction_method=None, construction_status=None, construction_type=None, exterior_wall_type=None, roof_material_type=None, roof_style_type=None, foundation_type=None, foundation_material=None, condition_ratings=None, quality_ratings=None, heating_types=None, heating_fuel_type=None, cooling_types=None, sewer_type=None, water_type=None, features=None, residential=None, commercial=None, renovations=None, extras=None, provenance=None, verifications=None))]
    pub fn new(property: String, id: String, kind: Option<String>, name: Option<String>, structure_number: Option<String>, living_area: Option<serde_utils::PyValue<Area>>, gross_area: Option<serde_utils::PyValue<Area>>, rentable_area: Option<serde_utils::PyValue<Area>>, ground_floor_area: Option<serde_utils::PyValue<Area>>, basement_area: Option<serde_utils::PyValue<Area>>, basement_finished_area: Option<serde_utils::PyValue<Area>>, garage_area: Option<serde_utils::PyValue<Area>>, areas: Option<serde_utils::PyValue<Vec<AreaMeasure>>>, year_built: Option<isize>, year_built_estimated: Option<bool>, effective_year_built: Option<isize>, stories: Option<f64>, unit_count: Option<isize>, construction_method: Option<String>, construction_status: Option<String>, construction_type: Option<String>, exterior_wall_type: Option<String>, roof_material_type: Option<String>, roof_style_type: Option<String>, foundation_type: Option<String>, foundation_material: Option<String>, condition_ratings: Option<serde_utils::PyValue<Vec<RatingOrSubtype>>>, quality_ratings: Option<serde_utils::PyValue<Vec<RatingOrSubtype>>>, heating_types: Option<Vec<String>>, heating_fuel_type: Option<String>, cooling_types: Option<Vec<String>>, sewer_type: Option<String>, water_type: Option<String>, features: Option<Vec<String>>, residential: Option<serde_utils::PyValue<ResidentialDetails>>, commercial: Option<serde_utils::PyValue<BomaInternationalCommercialDetails>>, renovations: Option<serde_utils::PyValue<Vec<Renovation>>>, extras: Option<serde_utils::PyValue<Any>>, provenance: Option<serde_utils::PyValue<Provenance>>, verifications: Option<serde_utils::PyValue<Vec<VerificationAttribution>>>) -> Self {
        let living_area = living_area.map(|v| v.into_inner());
        let gross_area = gross_area.map(|v| v.into_inner());
        let rentable_area = rentable_area.map(|v| v.into_inner());
        let ground_floor_area = ground_floor_area.map(|v| v.into_inner());
        ...
        let provenance = provenance.map(|v| v.into_inner());
        let verifications = verifications.map(|v| v.into_inner());
        BomaInternationalStructure{property, id, kind, name, structure_number, living_area, gross_area, rentable_area, ground_floor_area, basement_area, basement_finished_area, garage_area, areas, year_built, year_built_estimated, effective_year_built, stories, unit_count, construction_method, construction_status, construction_type, exterior_wall_type, roof_material_type, roof_style_type, foundation_type, foundation_material, condition_ratings, quality_ratings, heating_types, heating_fuel_type, cooling_types, sewer_type, water_type, features, residential, commercial, renovations, extras, provenance, verifications}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaInternationalStructure>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaInternationalStructure> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaInternationalStructure>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaInternationalStructure",
        ))
    }
}
...
#[cfg(feature = "serde")]
impl serde_utils::InlinedPair for BomaInternationalStructure {
    type Key   = String;
    type Value = Value;
    type Error = String;
    ...
    fn from_pair_simple(_k: Self::Key, _v: Value) -> Result<Self,Self::Error> {
        Err("Cannot create a BomaInternationalStructure from a primitive value!".into())
    }
...
pub mod commercial_details_utl {
    use super::*;
    #[derive(Debug, Clone, PartialEq)]
    #[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
    pub enum market_classification_range {
        Rating(Rating),
        BomaMetroOfficeMarketClassification(BomaMetroOfficeMarketClassification),
        BomaInternationalOfficeMarketClassification(BomaInternationalOfficeMarketClassification)    }

    #[cfg(feature = "pyo3")]
    impl<'py> FromPyObject<'py> for market_classification_range {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            if let Ok(val) = ob.extract::<Rating>() {
                return Ok(market_classification_range::Rating(val));
            }            if let Ok(val) = ob.extract::<BomaMetroOfficeMarketClassification>() {
                return Ok(market_classification_range::BomaMetroOfficeMarketClassification(val));
            }            if let Ok(val) = ob.extract::<BomaInternationalOfficeMarketClassification>() {
                return Ok(market_classification_range::BomaInternationalOfficeMarketClassification(val));
            }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                "invalid market_classification",
            ))
        }
    }

    #[cfg(feature = "pyo3")]
    impl<'py> IntoPyObject<'py> for market_classification_range {
        type Target = PyAny;
        type Output = Bound<'py, Self::Target>;
        type Error = PyErr;
        ...
        fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
            match self {
                market_classification_range::Rating(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                market_classification_range::BomaMetroOfficeMarketClassification(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                market_classification_range::BomaInternationalOfficeMarketClassification(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
            }
        }
    }
    ...
    #[cfg(feature = "pyo3")]
    impl<'py> IntoPyObject<'py> for Box<market_classification_range>
    {
        type Target = PyAny;
        type Output = Bound<'py, Self::Target>;
        type Error = PyErr;
    ...
    #[cfg(feature = "pyo3")]
    impl<'py> FromPyObject<'py> for Box<market_classification_range> {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            if let Ok(val) = ob.extract::<market_classification_range>() {
                return Ok(Box::new(val));
            }
            Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                "invalid market_classification",
    ...
    #[cfg(feature = "stubgen")]
    ::pyo3_stub_gen::impl_stub_type!(market_classification_range = Rating | BomaMetroOfficeMarketClassification | BomaInternationalOfficeMarketClassification);
}
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature="serde", serde(untagged))]
pub enum CommercialDetailsOrSubtype {    BomaMetroCommercialDetails(BomaMetroCommercialDetails),     BomaInternationalCommercialDetails(BomaInternationalCommercialDetails)}

impl From<BomaMetroCommercialDetails>   for CommercialDetailsOrSubtype { fn from(x: BomaMetroCommercialDetails)   -> Self { Self::BomaMetroCommercialDetails(x) } }
impl From<BomaInternationalCommercialDetails>   for CommercialDetailsOrSubtype { fn from(x: BomaInternationalCommercialDetails)   -> Self { Self::BomaInternationalCommercialDetails(x) } }

#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for CommercialDetailsOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroCommercialDetails>() {
            return Ok(CommercialDetailsOrSubtype::BomaMetroCommercialDetails(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalCommercialDetails>() {
            return Ok(CommercialDetailsOrSubtype::BomaInternationalCommercialDetails(val));
        }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid CommercialDetailsOrSubtype",
        ))
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for CommercialDetailsOrSubtype {
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            CommercialDetailsOrSubtype::BomaMetroCommercialDetails(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            CommercialDetailsOrSubtype::BomaInternationalCommercialDetails(val) => val.into_pyobject(py).map(move |b| b.into_any()),
        }
    }
}
...
#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<CommercialDetailsOrSubtype>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<CommercialDetailsOrSubtype> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<CommercialDetailsOrSubtype>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid CommercialDetailsOrSubtype",
...
#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(CommercialDetailsOrSubtype = BomaMetroCommercialDetails | BomaInternationalCommercialDetails);
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaMetroCommercialDetails {
    #[cfg_attr(feature = "serde", serde(default))]
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaMetroCommercialDetails {
    #[new]
    #[pyo3(signature = (market_classification=None, clear_height=None, dock_doors=None, drive_in_doors=None, occupancy_pct=None, parking_spaces=None, parking_ratio=None, tenancy=None, tenant_count=None, parking_types=None, has_sprinkler=None, elevators=None, submarket=None, extras=None, provenance=None))]
    pub fn new(market_classification: Option<serde_utils::PyValue<BomaMetroOfficeMarketClassification>>, clear_height: Option<serde_utils::PyValue<Length>>, dock_doors: Option<isize>, drive_in_doors: Option<isize>, occupancy_pct: Option<f64>, parking_spaces: Option<isize>, parking_ratio: Option<serde_utils::PyValue<UnitRate>>, tenancy: Option<String>, tenant_count: Option<isize>, parking_types: Option<Vec<String>>, has_sprinkler: Option<bool>, elevators: Option<isize>, submarket: Option<String>, extras: Option<serde_utils::PyValue<Any>>, provenance: Option<serde_utils::PyValue<Provenance>>) -> Self {
        let market_classification = market_classification.map(|v| v.into_inner());
        let clear_height = clear_height.map(|v| v.into_inner());
        let parking_ratio = parking_ratio.map(|v| v.into_inner());
        let extras = extras.map(|v| v.into_inner());
        let provenance = provenance.map(|v| v.into_inner());
        BomaMetroCommercialDetails{market_classification, clear_height, dock_doors, drive_in_doors, occupancy_pct, parking_spaces, parking_ratio, tenancy, tenant_count, parking_types, has_sprinkler, elevators, submarket, extras, provenance}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaMetroCommercialDetails>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaMetroCommercialDetails> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroCommercialDetails>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaMetroCommercialDetails",
        ))
    }
}
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaInternationalCommercialDetails {
    #[cfg_attr(feature = "serde", serde(default))]
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaInternationalCommercialDetails {
    #[new]
    #[pyo3(signature = (market_classification=None, clear_height=None, dock_doors=None, drive_in_doors=None, occupancy_pct=None, parking_spaces=None, parking_ratio=None, tenancy=None, tenant_count=None, parking_types=None, has_sprinkler=None, elevators=None, submarket=None, extras=None, provenance=None))]
    pub fn new(market_classification: Option<serde_utils::PyValue<BomaInternationalOfficeMarketClassification>>, clear_height: Option<serde_utils::PyValue<Length>>, dock_doors: Option<isize>, drive_in_doors: Option<isize>, occupancy_pct: Option<f64>, parking_spaces: Option<isize>, parking_ratio: Option<serde_utils::PyValue<UnitRate>>, tenancy: Option<String>, tenant_count: Option<isize>, parking_types: Option<Vec<String>>, has_sprinkler: Option<bool>, elevators: Option<isize>, submarket: Option<String>, extras: Option<serde_utils::PyValue<Any>>, provenance: Option<serde_utils::PyValue<Provenance>>) -> Self {
        let market_classification = market_classification.map(|v| v.into_inner());
        let clear_height = clear_height.map(|v| v.into_inner());
        let parking_ratio = parking_ratio.map(|v| v.into_inner());
        let extras = extras.map(|v| v.into_inner());
        let provenance = provenance.map(|v| v.into_inner());
        BomaInternationalCommercialDetails{market_classification, clear_height, dock_doors, drive_in_doors, occupancy_pct, parking_spaces, parking_ratio, tenancy, tenant_count, parking_types, has_sprinkler, elevators, submarket, extras, provenance}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaInternationalCommercialDetails>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaInternationalCommercialDetails> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaInternationalCommercialDetails>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaInternationalCommercialDetails",
        ))
    }
}
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature="serde", serde(untagged))]
pub enum StructureStateOrSubtype {    BomaMetroStructureState(BomaMetroStructureState),     BomaInternationalStructureState(BomaInternationalStructureState)}

impl From<BomaMetroStructureState>   for StructureStateOrSubtype { fn from(x: BomaMetroStructureState)   -> Self { Self::BomaMetroStructureState(x) } }
impl From<BomaInternationalStructureState>   for StructureStateOrSubtype { fn from(x: BomaInternationalStructureState)   -> Self { Self::BomaInternationalStructureState(x) } }

#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for StructureStateOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroStructureState>() {
            return Ok(StructureStateOrSubtype::BomaMetroStructureState(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalStructureState>() {
            return Ok(StructureStateOrSubtype::BomaInternationalStructureState(val));
        }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
...
impl<'py> IntoPyObject<'py> for StructureStateOrSubtype {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            StructureStateOrSubtype::BomaMetroStructureState(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            StructureStateOrSubtype::BomaInternationalStructureState(val) => val.into_pyobject(py).map(move |b| b.into_any()),
        }
    }
}
...
impl serde_utils::InlinedPair for StructureStateOrSubtype {
    ...
    fn from_pair_mapping(k: Self::Key, v: Self::Value) -> Result<Self, Self::Error> {
        if let Ok(x) = BomaMetroStructureState::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(StructureStateOrSubtype::BomaMetroStructureState(x));
        }
        if let Ok(x) = BomaInternationalStructureState::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(StructureStateOrSubtype::BomaInternationalStructureState(x));
        }
        Err("none of the variants matched the mapping form".into())
    }
    ...
    fn extract_key(&self) -> &Self::Key {
        match self {
            StructureStateOrSubtype::BomaMetroStructureState(inner) => inner.extract_key(),
            StructureStateOrSubtype::BomaInternationalStructureState(inner) => inner.extract_key(),
        }
    }
}

#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(StructureStateOrSubtype = BomaMetroStructureState | BomaInternationalStructureState);
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaMetroStructureState {
    pub subject: String,
    #[cfg_attr(feature = "serde", serde(default))]
    pub kind: Option<String>,
    #[cfg_attr(feature = "serde", serde(default))]
...
impl BomaMetroStructureState {
    ...
    pub fn new(subject: String, id: String, kind: Option<String>, name: Option<String>, structure_number: Option<String>, living_area: Option<serde_utils::PyValue<Area>>, gross_area: Option<serde_utils::PyValue<Area>>, rentable_area: Option<serde_utils::PyValue<Area>>, ground_floor_area: Option<serde_utils::PyValue<Area>>, basement_area: Option<serde_utils::PyValue<Area>>, basement_finished_area: Option<serde_utils::PyValue<Area>>, garage_area: Option<serde_utils::PyValue<Area>>, areas: Option<serde_utils::PyValue<Vec<AreaMeasure>>>, year_built: Option<isize>, year_built_estimated: Option<bool>, effective_year_built: Option<isize>, stories: Option<f64>, unit_count: Option<isize>, construction_method: Option<String>, construction_status: Option<String>, construction_type: Option<String>, exterior_wall_type: Option<String>, roof_material_type: Option<String>, roof_style_type: Option<String>, foundation_type: Option<String>, foundation_material: Option<String>, condition_ratings: Option<serde_utils::PyValue<Vec<RatingOrSubtype>>>, quality_ratings: Option<serde_utils::PyValue<Vec<RatingOrSubtype>>>, heating_types: Option<Vec<String>>, heating_fuel_type: Option<String>, cooling_types: Option<Vec<String>>, sewer_type: Option<String>, water_type: Option<String>, features: Option<Vec<String>>, residential: Option<serde_utils::PyValue<ResidentialDetails>>, commercial: Option<serde_utils::PyValue<BomaMetroCommercialDetails>>, renovations: Option<serde_utils::PyValue<Vec<Renovation>>>, extras: Option<serde_utils::PyValue<Any>>, provenance: Option<serde_utils::PyValue<Provenance>>, verifications: Option<serde_utils::PyValue<Vec<VerificationAttribution>>>) -> Self {
        ...
        let provenance = provenance.map(|v| v.into_inner());
        let verifications = verifications.map(|v| v.into_inner());
        BomaMetroStructureState{subject, id, kind, name, structure_number, living_area, gross_area, rentable_area, ground_floor_area, basement_area, basement_finished_area, garage_area, areas, year_built, year_built_estimated, effective_year_built, stories, unit_count, construction_method, construction_status, construction_type, exterior_wall_type, roof_material_type, roof_style_type, foundation_type, foundation_material, condition_ratings, quality_ratings, heating_types, heating_fuel_type, cooling_types, sewer_type, water_type, features, residential, commercial, renovations, extras, provenance, verifications}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaMetroStructureState>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaMetroStructureState> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroStructureState>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaMetroStructureState",
        ))
    }
}
...
#[cfg(feature = "serde")]
impl serde_utils::InlinedPair for BomaMetroStructureState {
    type Key   = String;
    type Value = Value;
    type Error = String;
    ...
    fn from_pair_simple(_k: Self::Key, _v: Value) -> Result<Self,Self::Error> {
        Err("Cannot create a BomaMetroStructureState from a primitive value!".into())
    }
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaInternationalStructureState {
    pub subject: String,
    #[cfg_attr(feature = "serde", serde(default))]
    pub kind: Option<String>,
    #[cfg_attr(feature = "serde", serde(default))]
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaInternationalStructureState {
    #[new]
    #[pyo3(signature = (subject, id, kind=None, name=None, structure_number=None, living_area=None, gross_area=None, rentable_area=None, ground_floor_area=None, basement_area=None, basement_finished_area=None, garage_area=None, areas=None, year_built=None, year_built_estimated=None, effective_year_built=None, stories=None, unit_count=None, construction_method=None, construction_status=None, construction_type=None, exterior_wall_type=None, roof_material_type=None, roof_style_type=None, foundation_type=None, foundation_material=None, condition_ratings=None, quality_ratings=None, heating_types=None, heating_fuel_type=None, cooling_types=None, sewer_type=None, water_type=None, features=None, residential=None, commercial=None, renovations=None, extras=None, provenance=None, verifications=None))]
    pub fn new(subject: String, id: String, kind: Option<String>, name: Option<String>, structure_number: Option<String>, living_area: Option<serde_utils::PyValue<Area>>, gross_area: Option<serde_utils::PyValue<Area>>, rentable_area: Option<serde_utils::PyValue<Area>>, ground_floor_area: Option<serde_utils::PyValue<Area>>, basement_area: Option<serde_utils::PyValue<Area>>, basement_finished_area: Option<serde_utils::PyValue<Area>>, garage_area: Option<serde_utils::PyValue<Area>>, areas: Option<serde_utils::PyValue<Vec<AreaMeasure>>>, year_built: Option<isize>, year_built_estimated: Option<bool>, effective_year_built: Option<isize>, stories: Option<f64>, unit_count: Option<isize>, construction_method: Option<String>, construction_status: Option<String>, construction_type: Option<String>, exterior_wall_type: Option<String>, roof_material_type: Option<String>, roof_style_type: Option<String>, foundation_type: Option<String>, foundation_material: Option<String>, condition_ratings: Option<serde_utils::PyValue<Vec<RatingOrSubtype>>>, quality_ratings: Option<serde_utils::PyValue<Vec<RatingOrSubtype>>>, heating_types: Option<Vec<String>>, heating_fuel_type: Option<String>, cooling_types: Option<Vec<String>>, sewer_type: Option<String>, water_type: Option<String>, features: Option<Vec<String>>, residential: Option<serde_utils::PyValue<ResidentialDetails>>, commercial: Option<serde_utils::PyValue<BomaInternationalCommercialDetails>>, renovations: Option<serde_utils::PyValue<Vec<Renovation>>>, extras: Option<serde_utils::PyValue<Any>>, provenance: Option<serde_utils::PyValue<Provenance>>, verifications: Option<serde_utils::PyValue<Vec<VerificationAttribution>>>) -> Self {
        let living_area = living_area.map(|v| v.into_inner());
        ...
        let provenance = provenance.map(|v| v.into_inner());
        let verifications = verifications.map(|v| v.into_inner());
        BomaInternationalStructureState{subject, id, kind, name, structure_number, living_area, gross_area, rentable_area, ground_floor_area, basement_area, basement_finished_area, garage_area, areas, year_built, year_built_estimated, effective_year_built, stories, unit_count, construction_method, construction_status, construction_type, exterior_wall_type, roof_material_type, roof_style_type, foundation_type, foundation_material, condition_ratings, quality_ratings, heating_types, heating_fuel_type, cooling_types, sewer_type, water_type, features, residential, commercial, renovations, extras, provenance, verifications}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaInternationalStructureState>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaInternationalStructureState> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaInternationalStructureState>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaInternationalStructureState",
        ))
    }
}
...
#[cfg(feature = "serde")]
impl serde_utils::InlinedPair for BomaInternationalStructureState {
    type Key   = String;
    type Value = Value;
    type Error = String;
    ...
    fn from_pair_simple(_k: Self::Key, _v: Value) -> Result<Self,Self::Error> {
        Err("Cannot create a BomaInternationalStructureState from a primitive value!".into())
    }
...
pub mod property_state_snapshot_utl {
    ...
    pub enum structure_states_range {
        ...
        BomaMetroStructureState(BomaMetroStructureState),
        BomaInternationalStructureState(BomaInternationalStructureState)    }
    ...
    impl<'py> FromPyObject<'py> for structure_states_range {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            if let Ok(val) = ob.extract::<StructureState>() {
                ...
                return Ok(structure_states_range::BomaMetroStructureState(val));
            }            if let Ok(val) = ob.extract::<BomaInternationalStructureState>() {
                return Ok(structure_states_range::BomaInternationalStructureState(val));
            }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
    ...
    impl<'py> IntoPyObject<'py> for structure_states_range {
        ...
        fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
            match self {
                ...
                structure_states_range::BomaMetroStructureState(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                structure_states_range::BomaInternationalStructureState(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
            }
        }
    }
    ...
    #[cfg(feature = "stubgen")]
    ::pyo3_stub_gen::impl_stub_type!(structure_states_range = StructureState | BomaMetroStructureState | BomaInternationalStructureState);
}
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature="serde", serde(untagged))]
pub enum PropertyStateSnapshotOrSubtype {    BomaMetroPropertyStateSnapshot(BomaMetroPropertyStateSnapshot),     BomaInternationalPropertyStateSnapshot(BomaInternationalPropertyStateSnapshot)}

impl From<BomaMetroPropertyStateSnapshot>   for PropertyStateSnapshotOrSubtype { fn from(x: BomaMetroPropertyStateSnapshot)   -> Self { Self::BomaMetroPropertyStateSnapshot(x) } }
impl From<BomaInternationalPropertyStateSnapshot>   for PropertyStateSnapshotOrSubtype { fn from(x: BomaInternationalPropertyStateSnapshot)   -> Self { Self::BomaInternationalPropertyStateSnapshot(x) } }

#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for PropertyStateSnapshotOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroPropertyStateSnapshot>() {
            return Ok(PropertyStateSnapshotOrSubtype::BomaMetroPropertyStateSnapshot(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalPropertyStateSnapshot>() {
            return Ok(PropertyStateSnapshotOrSubtype::BomaInternationalPropertyStateSnapshot(val));
        }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
...
impl<'py> IntoPyObject<'py> for PropertyStateSnapshotOrSubtype {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            PropertyStateSnapshotOrSubtype::BomaMetroPropertyStateSnapshot(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            PropertyStateSnapshotOrSubtype::BomaInternationalPropertyStateSnapshot(val) => val.into_pyobject(py).map(move |b| b.into_any()),
        }
    }
}
...
impl serde_utils::InlinedPair for PropertyStateSnapshotOrSubtype {
    ...
    fn from_pair_mapping(k: Self::Key, v: Self::Value) -> Result<Self, Self::Error> {
        if let Ok(x) = BomaMetroPropertyStateSnapshot::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(PropertyStateSnapshotOrSubtype::BomaMetroPropertyStateSnapshot(x));
        }
        if let Ok(x) = BomaInternationalPropertyStateSnapshot::from_pair_mapping(k.clone(), v.clone()) {
            return Ok(PropertyStateSnapshotOrSubtype::BomaInternationalPropertyStateSnapshot(x));
        }
        Err("none of the variants matched the mapping form".into())
    }
    ...
    fn extract_key(&self) -> &Self::Key {
        match self {
            PropertyStateSnapshotOrSubtype::BomaMetroPropertyStateSnapshot(inner) => inner.extract_key(),
            PropertyStateSnapshotOrSubtype::BomaInternationalPropertyStateSnapshot(inner) => inner.extract_key(),
        }
    }
}

#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(PropertyStateSnapshotOrSubtype = BomaMetroPropertyStateSnapshot | BomaInternationalPropertyStateSnapshot);
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaMetroPropertyStateSnapshot {
    pub property: String,
    pub as_of_date: NaiveDate,
    #[cfg_attr(feature = "serde", serde(default))]
    pub basis: Option<CodeableConceptOrSubtype>,
    ...
    #[cfg_attr(feature = "serde", serde(default))]
    pub structure_states: Option<Vec<BomaMetroStructureState>>,
    #[cfg_attr(feature = "serde", serde(
        deserialize_with = "serde_utils::deserialize_inlined_dict_list_optional",
        serialize_with = "serde_utils::serialize_inlined_dict_list_optional"
    ))]
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaMetroPropertyStateSnapshot {
    #[new]
    #[pyo3(signature = (property, as_of_date, id, basis=None, property_state=None, site_states=None, structure_states=None, space_states=None, extras=None, provenance=None, verifications=None))]
    pub fn new(property: String, as_of_date: NaiveDate, id: String, basis: Option<serde_utils::PyValue<CodeableConceptOrSubtype>>, property_state: Option<serde_utils::PyValue<PropertyState>>, site_states: Option<serde_utils::PyValue<Vec<SiteState>>>, structure_states: Option<serde_utils::PyValue<Vec<BomaMetroStructureState>>>, space_states: Option<serde_utils::PyValue<Vec<SpaceState>>>, extras: Option<serde_utils::PyValue<Any>>, provenance: Option<serde_utils::PyValue<Provenance>>, verifications: Option<serde_utils::PyValue<Vec<VerificationAttribution>>>) -> Self {
        let basis = basis.map(|v| v.into_inner());
        let property_state = property_state.map(|v| v.into_inner());
        let site_states = site_states.map(|v| v.into_inner());
        let structure_states = structure_states.map(|v| v.into_inner());
        ...
        let provenance = provenance.map(|v| v.into_inner());
        let verifications = verifications.map(|v| v.into_inner());
        BomaMetroPropertyStateSnapshot{property, as_of_date, id, basis, property_state, site_states, structure_states, space_states, extras, provenance, verifications}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaMetroPropertyStateSnapshot>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaMetroPropertyStateSnapshot> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroPropertyStateSnapshot>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaMetroPropertyStateSnapshot",
        ))
    }
}
...
#[cfg(feature = "serde")]
impl serde_utils::InlinedPair for BomaMetroPropertyStateSnapshot {
    type Key   = String;
    type Value = Value;
    type Error = String;
    ...
    fn from_pair_simple(_k: Self::Key, _v: Value) -> Result<Self,Self::Error> {
        Err("Cannot create a BomaMetroPropertyStateSnapshot from a primitive value!".into())
    }
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaInternationalPropertyStateSnapshot {
    pub property: String,
    pub as_of_date: NaiveDate,
    #[cfg_attr(feature = "serde", serde(default))]
    pub basis: Option<CodeableConceptOrSubtype>,
    ...
    #[cfg_attr(feature = "serde", serde(default))]
    pub structure_states: Option<Vec<BomaInternationalStructureState>>,
    #[cfg_attr(feature = "serde", serde(
        deserialize_with = "serde_utils::deserialize_inlined_dict_list_optional",
        serialize_with = "serde_utils::serialize_inlined_dict_list_optional"
    ))]
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaInternationalPropertyStateSnapshot {
    #[new]
    #[pyo3(signature = (property, as_of_date, id, basis=None, property_state=None, site_states=None, structure_states=None, space_states=None, extras=None, provenance=None, verifications=None))]
    pub fn new(property: String, as_of_date: NaiveDate, id: String, basis: Option<serde_utils::PyValue<CodeableConceptOrSubtype>>, property_state: Option<serde_utils::PyValue<PropertyState>>, site_states: Option<serde_utils::PyValue<Vec<SiteState>>>, structure_states: Option<serde_utils::PyValue<Vec<BomaInternationalStructureState>>>, space_states: Option<serde_utils::PyValue<Vec<SpaceState>>>, extras: Option<serde_utils::PyValue<Any>>, provenance: Option<serde_utils::PyValue<Provenance>>, verifications: Option<serde_utils::PyValue<Vec<VerificationAttribution>>>) -> Self {
        let basis = basis.map(|v| v.into_inner());
        let property_state = property_state.map(|v| v.into_inner());
        let site_states = site_states.map(|v| v.into_inner());
        let structure_states = structure_states.map(|v| v.into_inner());
        ...
        let provenance = provenance.map(|v| v.into_inner());
        let verifications = verifications.map(|v| v.into_inner());
        BomaInternationalPropertyStateSnapshot{property, as_of_date, id, basis, property_state, site_states, structure_states, space_states, extras, provenance, verifications}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaInternationalPropertyStateSnapshot>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaInternationalPropertyStateSnapshot> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaInternationalPropertyStateSnapshot>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaInternationalPropertyStateSnapshot",
        ))
    }
}
...
#[cfg(feature = "serde")]
impl serde_utils::InlinedPair for BomaInternationalPropertyStateSnapshot {
    type Key   = String;
    type Value = Value;
    type Error = String;
    ...
    fn from_pair_simple(_k: Self::Key, _v: Value) -> Result<Self,Self::Error> {
        Err("Cannot create a BomaInternationalPropertyStateSnapshot from a primitive value!".into())
    }
...
pub mod property_profile_utl {
    ...
    pub enum structures_range {
        Structure(Structure),
        BomaMetroStructure(BomaMetroStructure),
        BomaInternationalStructure(BomaInternationalStructure)    }
    ...
    impl<'py> FromPyObject<'py> for structures_range {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            if let Ok(val) = ob.extract::<Structure>() {
                ...
                return Ok(structures_range::BomaMetroStructure(val));
            }            if let Ok(val) = ob.extract::<BomaInternationalStructure>() {
                return Ok(structures_range::BomaInternationalStructure(val));
            }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
                "invalid structures",
            ))
        }
    ...
    impl<'py> IntoPyObject<'py> for structures_range {
        ...
        fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
            match self {
                ...
                structures_range::BomaMetroStructure(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                structures_range::BomaInternationalStructure(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
            }
        }
    }
    ...
    #[cfg(feature = "stubgen")]
    ::pyo3_stub_gen::impl_stub_type!(structures_range = Structure | BomaMetroStructure | BomaInternationalStructure);
    #[derive(Debug, Clone, PartialEq)]
    #[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
    pub enum property_state_snapshots_range {
        PropertyStateSnapshot(PropertyStateSnapshot),
        BomaMetroPropertyStateSnapshot(BomaMetroPropertyStateSnapshot),
        BomaInternationalPropertyStateSnapshot(BomaInternationalPropertyStateSnapshot)    }
    ...
    impl<'py> FromPyObject<'py> for property_state_snapshots_range {
        fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
            if let Ok(val) = ob.extract::<PropertyStateSnapshot>() {
                ...
                return Ok(property_state_snapshots_range::BomaMetroPropertyStateSnapshot(val));
            }            if let Ok(val) = ob.extract::<BomaInternationalPropertyStateSnapshot>() {
                return Ok(property_state_snapshots_range::BomaInternationalPropertyStateSnapshot(val));
            }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
    ...
    impl<'py> IntoPyObject<'py> for property_state_snapshots_range {
        ...
        fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
            match self {
                ...
                property_state_snapshots_range::BomaMetroPropertyStateSnapshot(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
                property_state_snapshots_range::BomaInternationalPropertyStateSnapshot(val) => Ok(val.into_pyobject(py).map(move |b| <pyo3::Bound<'_, _> as Clone>::clone(&b).into_any())?),
            }
        }
    }
    ...
    #[cfg(feature = "stubgen")]
    ::pyo3_stub_gen::impl_stub_type!(property_state_snapshots_range = PropertyStateSnapshot | BomaMetroPropertyStateSnapshot | BomaInternationalPropertyStateSnapshot);
}
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature="serde", serde(untagged))]
pub enum PropertyProfileOrSubtype {    BomaMetroPropertyProfile(BomaMetroPropertyProfile),     BomaInternationalPropertyProfile(BomaInternationalPropertyProfile)}

impl From<BomaMetroPropertyProfile>   for PropertyProfileOrSubtype { fn from(x: BomaMetroPropertyProfile)   -> Self { Self::BomaMetroPropertyProfile(x) } }
impl From<BomaInternationalPropertyProfile>   for PropertyProfileOrSubtype { fn from(x: BomaInternationalPropertyProfile)   -> Self { Self::BomaInternationalPropertyProfile(x) } }

#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for PropertyProfileOrSubtype {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroPropertyProfile>() {
            return Ok(PropertyProfileOrSubtype::BomaMetroPropertyProfile(val));
        }        if let Ok(val) = ob.extract::<BomaInternationalPropertyProfile>() {
            return Ok(PropertyProfileOrSubtype::BomaInternationalPropertyProfile(val));
        }Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
...
impl<'py> IntoPyObject<'py> for PropertyProfileOrSubtype {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        match self {
            PropertyProfileOrSubtype::BomaMetroPropertyProfile(val) => val.into_pyobject(py).map(move |b| b.into_any()),
            PropertyProfileOrSubtype::BomaInternationalPropertyProfile(val) => val.into_pyobject(py).map(move |b| b.into_any()),
        }
    }
}
...
#[cfg(feature = "stubgen")]
::pyo3_stub_gen::impl_stub_type!(PropertyProfileOrSubtype = BomaMetroPropertyProfile | BomaInternationalPropertyProfile);
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaMetroPropertyProfile {
    #[cfg_attr(feature = "serde", serde(
        deserialize_with = "serde_utils::deserialize_inlined_dict_list_optional",
        serialize_with = "serde_utils::serialize_inlined_dict_list_optional"
    ))]
    ...
    #[cfg_attr(feature = "serde", serde(default))]
    pub property_state_snapshots: Option<Vec<BomaMetroPropertyStateSnapshot>>,
    #[cfg_attr(feature = "serde", serde(
        deserialize_with = "serde_utils::deserialize_inlined_dict_list_optional",
        serialize_with = "serde_utils::serialize_inlined_dict_list_optional"
    ))]
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaMetroPropertyProfile {
    #[new]
    #[pyo3(signature = (property, parties=None, artifacts=None, addresses=None, property_addresses=None, identifiers=None, jurisdictions=None, parcels=None, property_parcels=None, parcel_lineage=None, site=None, structures=None, spaces=None, property_state_snapshots=None, associations=None, assessments=None, tax_bills=None, transfers=None, sales=None, listings=None, leases=None, unit_rents=None, rent_rolls=None, loans=None, liens=None, foreclosure_cases=None, permits=None, ownership=None, operating_statements=None, valuations=None, provenance=None, extras=None))]
    pub fn new(property: serde_utils::PyValue<Property>, parties: Option<serde_utils::PyValue<Vec<Party>>>, artifacts: Option<serde_utils::PyValue<Vec<SourceArtifact>>>, addresses: Option<serde_utils::PyValue<Vec<Address>>>, property_addresses: Option<serde_utils::PyValue<Vec<PropertyAddress>>>, identifiers: Option<serde_utils::PyValue<Vec<PropertyIdentifier>>>, jurisdictions: Option<serde_utils::PyValue<Vec<Jurisdiction>>>, parcels: Option<serde_utils::PyValue<Vec<Parcel>>>, property_parcels: Option<serde_utils::PyValue<Vec<PropertyParcel>>>, parcel_lineage: Option<serde_utils::PyValue<Vec<ParcelLineage>>>, site: Option<serde_utils::PyValue<Site>>, structures: Option<serde_utils::PyValue<Vec<BomaMetroStructure>>>, spaces: Option<serde_utils::PyValue<Vec<Space>>>, property_state_snapshots: Option<serde_utils::PyValue<Vec<BomaMetroPropertyStateSnapshot>>>, associations: Option<serde_utils::PyValue<Vec<PropertyAssociation>>>, assessments: Option<serde_utils::PyValue<Vec<Assessment>>>, tax_bills: Option<serde_utils::PyValue<Vec<TaxBill>>>, transfers: Option<serde_utils::PyValue<Vec<Transfer>>>, sales: Option<serde_utils::PyValue<Vec<SaleEvent>>>, listings: Option<serde_utils::PyValue<Vec<Listing>>>, leases: Option<serde_utils::PyValue<Vec<LeaseEvent>>>, unit_rents: Option<serde_utils::PyValue<Vec<UnitRentObservation>>>, rent_rolls: Option<serde_utils::PyValue<Vec<RentRoll>>>, loans: Option<serde_utils::PyValue<Vec<Loan>>>, liens: Option<serde_utils::PyValue<Vec<Lien>>>, foreclosure_cases: Option<serde_utils::PyValue<Vec<ForeclosureCase>>>, permits: Option<serde_utils::PyValue<Vec<Permit>>>, ownership: Option<serde_utils::PyValue<Vec<OwnershipPeriod>>>, operating_statements: Option<serde_utils::PyValue<Vec<OperatingStatement>>>, valuations: Option<serde_utils::PyValue<Vec<Valuation>>>, provenance: Option<serde_utils::PyValue<Provenance>>, extras: Option<serde_utils::PyValue<Any>>) -> Self {
        let property = property.into_inner();
        let parties = parties.map(|v| v.into_inner());
        let artifacts = artifacts.map(|v| v.into_inner());
        let addresses = addresses.map(|v| v.into_inner());
        ...
        let provenance = provenance.map(|v| v.into_inner());
        let extras = extras.map(|v| v.into_inner());
        BomaMetroPropertyProfile{property, parties, artifacts, addresses, property_addresses, identifiers, jurisdictions, parcels, property_parcels, parcel_lineage, site, structures, spaces, property_state_snapshots, associations, assessments, tax_bills, transfers, sales, listings, leases, unit_rents, rent_rolls, loans, liens, foreclosure_cases, permits, ownership, operating_statements, valuations, provenance, extras}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaMetroPropertyProfile>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaMetroPropertyProfile> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaMetroPropertyProfile>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaMetroPropertyProfile",
        ))
    }
}
...
#[cfg_attr(feature = "stubgen", gen_stub_pyclass)]
#[cfg_attr(feature = "pyo3", pyclass(subclass, get_all, set_all))]
pub struct BomaInternationalPropertyProfile {
    #[cfg_attr(feature = "serde", serde(
        deserialize_with = "serde_utils::deserialize_inlined_dict_list_optional",
        serialize_with = "serde_utils::serialize_inlined_dict_list_optional"
    ))]
    ...
    #[cfg_attr(feature = "serde", serde(default))]
    pub property_state_snapshots: Option<Vec<BomaInternationalPropertyStateSnapshot>>,
    #[cfg_attr(feature = "serde", serde(
        deserialize_with = "serde_utils::deserialize_inlined_dict_list_optional",
        serialize_with = "serde_utils::serialize_inlined_dict_list_optional"
    ))]
...
#[cfg_attr(feature = "stubgen", gen_stub_pymethods)]
#[pymethods]
impl BomaInternationalPropertyProfile {
    #[new]
    #[pyo3(signature = (property, parties=None, artifacts=None, addresses=None, property_addresses=None, identifiers=None, jurisdictions=None, parcels=None, property_parcels=None, parcel_lineage=None, site=None, structures=None, spaces=None, property_state_snapshots=None, associations=None, assessments=None, tax_bills=None, transfers=None, sales=None, listings=None, leases=None, unit_rents=None, rent_rolls=None, loans=None, liens=None, foreclosure_cases=None, permits=None, ownership=None, operating_statements=None, valuations=None, provenance=None, extras=None))]
    pub fn new(property: serde_utils::PyValue<Property>, parties: Option<serde_utils::PyValue<Vec<Party>>>, artifacts: Option<serde_utils::PyValue<Vec<SourceArtifact>>>, addresses: Option<serde_utils::PyValue<Vec<Address>>>, property_addresses: Option<serde_utils::PyValue<Vec<PropertyAddress>>>, identifiers: Option<serde_utils::PyValue<Vec<PropertyIdentifier>>>, jurisdictions: Option<serde_utils::PyValue<Vec<Jurisdiction>>>, parcels: Option<serde_utils::PyValue<Vec<Parcel>>>, property_parcels: Option<serde_utils::PyValue<Vec<PropertyParcel>>>, parcel_lineage: Option<serde_utils::PyValue<Vec<ParcelLineage>>>, site: Option<serde_utils::PyValue<Site>>, structures: Option<serde_utils::PyValue<Vec<BomaInternationalStructure>>>, spaces: Option<serde_utils::PyValue<Vec<Space>>>, property_state_snapshots: Option<serde_utils::PyValue<Vec<BomaInternationalPropertyStateSnapshot>>>, associations: Option<serde_utils::PyValue<Vec<PropertyAssociation>>>, assessments: Option<serde_utils::PyValue<Vec<Assessment>>>, tax_bills: Option<serde_utils::PyValue<Vec<TaxBill>>>, transfers: Option<serde_utils::PyValue<Vec<Transfer>>>, sales: Option<serde_utils::PyValue<Vec<SaleEvent>>>, listings: Option<serde_utils::PyValue<Vec<Listing>>>, leases: Option<serde_utils::PyValue<Vec<LeaseEvent>>>, unit_rents: Option<serde_utils::PyValue<Vec<UnitRentObservation>>>, rent_rolls: Option<serde_utils::PyValue<Vec<RentRoll>>>, loans: Option<serde_utils::PyValue<Vec<Loan>>>, liens: Option<serde_utils::PyValue<Vec<Lien>>>, foreclosure_cases: Option<serde_utils::PyValue<Vec<ForeclosureCase>>>, permits: Option<serde_utils::PyValue<Vec<Permit>>>, ownership: Option<serde_utils::PyValue<Vec<OwnershipPeriod>>>, operating_statements: Option<serde_utils::PyValue<Vec<OperatingStatement>>>, valuations: Option<serde_utils::PyValue<Vec<Valuation>>>, provenance: Option<serde_utils::PyValue<Provenance>>, extras: Option<serde_utils::PyValue<Any>>) -> Self {
        let property = property.into_inner();
        let parties = parties.map(|v| v.into_inner());
        let artifacts = artifacts.map(|v| v.into_inner());
        let addresses = addresses.map(|v| v.into_inner());
        ...
        let provenance = provenance.map(|v| v.into_inner());
        let extras = extras.map(|v| v.into_inner());
        BomaInternationalPropertyProfile{property, parties, artifacts, addresses, property_addresses, identifiers, jurisdictions, parcels, property_parcels, parcel_lineage, site, structures, spaces, property_state_snapshots, associations, assessments, tax_bills, transfers, sales, listings, leases, unit_rents, rent_rolls, loans, liens, foreclosure_cases, permits, ownership, operating_statements, valuations, provenance, extras}
    }
}

#[cfg(feature = "pyo3")]
impl<'py> IntoPyObject<'py> for Box<BomaInternationalPropertyProfile>
{
    type Target = PyAny;
    type Output = Bound<'py, Self::Target>;
    type Error = PyErr;
...
#[cfg(feature = "pyo3")]
impl<'py> FromPyObject<'py> for Box<BomaInternationalPropertyProfile> {
    fn extract_bound(ob: &pyo3::Bound<'py, pyo3::types::PyAny>) -> pyo3::PyResult<Self> {
        if let Ok(val) = ob.extract::<BomaInternationalPropertyProfile>() {
            return Ok(Box::new(val));
        }
        Err(PyErr::new::<pyo3::exceptions::PyTypeError, _>(
            "invalid BomaInternationalPropertyProfile",
        ))
    }
}
