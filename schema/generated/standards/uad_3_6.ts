...
export type Uad36StructureId = string;
export type Uad36StructureStateId = string;
export type Uad36PropertyStateSnapshotId = string;
 ...
 */
export interface Uad36ConditionRating extends Rating {
    system: Uad36ConditionSystem,
    code: Uad36ConditionCode,
    scope: Uad36RatingScope,
}
 ...
 */
export interface Uad36QualityRating extends Rating {
    system: Uad36QualitySystem,
    code: Uad36QualityCode,
    scope: Uad36RatingScope,
}



export interface Uad36Structure extends Structure {
    /** Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair. */
...
export interface Uad36StructureState extends StructureState {
    /** Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair. */
    condition_ratings?: Uad36ConditionRating[],
    /** Construction-quality ratings. Semantic validation permits at most one rating for each system and scope pair. */
    quality_ratings?: Uad36QualityRating[],
...
export interface Uad36PropertyStateSnapshot extends PropertyStateSnapshot {
    structure_states?: Uad36StructureState[],
}
 ...
 */
export interface Uad36PropertyProfile extends PropertyProfile {
