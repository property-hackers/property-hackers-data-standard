...
export type BomaMetroStructureId = string;
export type BomaMetroStructureStateId = string;
export type BomaMetroPropertyStateSnapshotId = string;
export type BomaInternationalStructureId = string;
export type BomaInternationalStructureStateId = string;
export type BomaInternationalPropertyStateSnapshotId = string;
...
*/
export enum BomaInternationalCode {
 ...
 */
export interface BomaMetroOfficeMarketClassification extends Rating {
    system: BomaMetroSystem,
    code: BomaMetroCode,
}
 ...
 */
export interface BomaInternationalOfficeMarketClassification extends Rating {
    system: BomaInternationalSystem,
    code: BomaInternationalCode,
}



export interface BomaMetroCommercialDetails extends CommercialDetails {
    /** Competitive market positioning under the named rating system; distinct from physical condition and construction quality. */
...
export interface BomaInternationalCommercialDetails extends CommercialDetails {
    /** Competitive market positioning under the named rating system; distinct from physical condition and construction quality. */
...
export interface BomaMetroStructure extends Structure {
    commercial?: BomaMetroCommercialDetails,
}



export interface BomaMetroStructureState extends StructureState {
    commercial?: BomaMetroCommercialDetails,
}



export interface BomaMetroPropertyStateSnapshot extends PropertyStateSnapshot {
    structure_states?: BomaMetroStructureState[],
}
 ...
 */
export interface BomaMetroPropertyProfile extends PropertyProfile {
    structures?: BomaMetroStructure[],
    property_state_snapshots?: BomaMetroPropertyStateSnapshot[],
}



export interface BomaInternationalStructure extends Structure {
    commercial?: BomaInternationalCommercialDetails,
}



export interface BomaInternationalStructureState extends StructureState {
    commercial?: BomaInternationalCommercialDetails,
}



export interface BomaInternationalPropertyStateSnapshot extends PropertyStateSnapshot {
    structure_states?: BomaInternationalStructureState[],
}
 ...
 */
export interface BomaInternationalPropertyProfile extends PropertyProfile {
    structures?: BomaInternationalStructure[],
    property_state_snapshots?: BomaInternationalPropertyStateSnapshot[],
}
