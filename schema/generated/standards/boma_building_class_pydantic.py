...
linkml_meta = LinkMLMeta({'default_prefix': 'phds',
     ...
     'see_also': ['https://boma.org/boma-standards/building-class-definitions'],
     'source_file': 'schema/standards/boma_building_class.yaml',
     'title': 'PHDS BOMA Office Building Class Profiles'} )
...
class BomaMetroSystem(str, Enum):
    urnCOLONphdsCOLONstandardCOLONbomaCOLONofficeCOLONmetro = "urn:phds:standard:boma:office:metro"


class BomaInternationalSystem(str, Enum):
    urnCOLONphdsCOLONstandardCOLONbomaCOLONofficeCOLONinternational = "urn:phds:standard:boma:office:international"


class BomaMetroCode(str, Enum):
    A = "A"
    """
    Class A
    """
...
class BomaInternationalCode(str, Enum):
    """
...
class BomaMetroOfficeMarketClassification(Rating):
    """
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'code': {'name': 'code', 'range': 'BomaMetroCode'},
                        'system': {'name': 'system', 'range': 'BomaMetroSystem'}}})

    system: BomaMetroSystem = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept', 'Classification', 'Rating']} })
    code: BomaMetroCode = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept', 'Classification', 'Rating']} })
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Rating', 'Renovation', 'Permit']} })
    scope: Optional[RatingScope] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Rating']} })
    display: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept']} })
...
class BomaInternationalOfficeMarketClassification(Rating):
    """
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'code': {'name': 'code', 'range': 'BomaInternationalCode'},
                        'system': {'name': 'system',
                                   'range': 'BomaInternationalSystem'}}})

    system: BomaInternationalSystem = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept', 'Classification', 'Rating']} })
    code: BomaInternationalCode = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept', 'Classification', 'Rating']} })
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Rating', 'Renovation', 'Permit']} })
    scope: Optional[RatingScope] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Rating']} })
    display: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept']} })
...
class BomaMetroCommercialDetails(CommercialDetails):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'market_classification': {'name': 'market_classification',
                                                  'range': 'BomaMetroOfficeMarketClassification'}}})

    market_classification: Optional[BomaMetroOfficeMarketClassification] = Field(default=None, description="""Competitive market positioning under the named rating system; distinct from physical condition and construction quality.""", json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails']} })
    clear_height: Optional[Length] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails']} })
    dock_doors: Optional[int] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails']} })
    drive_in_doors: Optional[int] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails']} })
    occupancy_pct: Optional[Decimal] = Field(default=None, description="""0–100 percentage points; 95 means 95 percent.""", ge=0, le=100, json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails', 'RentRoll']} })
...
class BomaInternationalCommercialDetails(CommercialDetails):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'market_classification': {'name': 'market_classification',
                                                  'range': 'BomaInternationalOfficeMarketClassification'}}})

    market_classification: Optional[BomaInternationalOfficeMarketClassification] = Field(default=None, description="""Competitive market positioning under the named rating system; distinct from physical condition and construction quality.""", json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails']} })
    clear_height: Optional[Length] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails']} })
    dock_doors: Optional[int] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails']} })
    drive_in_doors: Optional[int] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails']} })
    occupancy_pct: Optional[Decimal] = Field(default=None, description="""0–100 percentage points; 95 means 95 percent.""", ge=0, le=100, json_schema_extra = { "linkml_meta": {'domain_of': ['CommercialDetails', 'RentRoll']} })
...
class BomaMetroStructure(Structure):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'commercial': {'name': 'commercial',
                                       'range': 'BomaMetroCommercialDetails'}}})
    ...
    features: Optional[list[str]] = Field(default=None, description="""Open vocabulary for physical features and amenities""", json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    residential: Optional[ResidentialDetails] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    commercial: Optional[BomaMetroCommercialDetails] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    renovations: Optional[list[Renovation]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    id: str = Field(default=..., description="""Canonical identifier; nonblank with no leading or trailing whitespace""", json_schema_extra = { "linkml_meta": {'domain_of': ['Entity']} })
    extras: Optional[Any] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Entity',
                       'InstrumentReference',
...
class BomaMetroStructureState(StructureState):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'commercial': {'name': 'commercial',
                                       'range': 'BomaMetroCommercialDetails'}}})
...
class BomaMetroPropertyStateSnapshot(PropertyStateSnapshot):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'structure_states': {'name': 'structure_states',
                                             'range': 'BomaMetroStructureState'}}})
    ...
    property_state: Optional[PropertyState] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot',
                       ...
                       'Valuation']} })
    site_states: Optional[list[SiteState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    structure_states: Optional[list[BomaMetroStructureState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    space_states: Optional[list[SpaceState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    id: str = Field(default=..., description="""Canonical identifier; nonblank with no leading or trailing whitespace""", json_schema_extra = { "linkml_meta": {'domain_of': ['Entity']} })
    extras: Optional[Any] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Entity',
                       'InstrumentReference',
...
class BomaMetroPropertyProfile(PropertyProfile):
    """
    Optional BOMA metropolitan-market office classification profile. Core PHDS does not depend on this profile.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'property_state_snapshots': {'name': 'property_state_snapshots',
                                                     'range': 'BomaMetroPropertyStateSnapshot'},
                        'structures': {'name': 'structures',
                                       'range': 'BomaMetroStructure'}},
         'tree_root': True})
    ...
    parcel_lineage: Optional[list[ParcelLineage]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    site: Optional[Site] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    structures: Optional[list[BomaMetroStructure]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    spaces: Optional[list[Space]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    property_state_snapshots: Optional[list[BomaMetroPropertyStateSnapshot]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    associations: Optional[list[PropertyAssociation]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    assessments: Optional[list[Assessment]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    tax_bills: Optional[list[TaxBill]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    transfers: Optional[list[Transfer]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
...
class BomaInternationalStructure(Structure):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'commercial': {'name': 'commercial',
                                       'range': 'BomaInternationalCommercialDetails'}}})
    ...
    features: Optional[list[str]] = Field(default=None, description="""Open vocabulary for physical features and amenities""", json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    residential: Optional[ResidentialDetails] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    commercial: Optional[BomaInternationalCommercialDetails] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    renovations: Optional[list[Renovation]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    id: str = Field(default=..., description="""Canonical identifier; nonblank with no leading or trailing whitespace""", json_schema_extra = { "linkml_meta": {'domain_of': ['Entity']} })
    extras: Optional[Any] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Entity',
                       'InstrumentReference',
...
class BomaInternationalStructureState(StructureState):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'commercial': {'name': 'commercial',
                                       'range': 'BomaInternationalCommercialDetails'}}})
...
class BomaInternationalPropertyStateSnapshot(PropertyStateSnapshot):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'structure_states': {'name': 'structure_states',
                                             'range': 'BomaInternationalStructureState'}}})
    ...
    property_state: Optional[PropertyState] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot',
                       ...
                       'Valuation']} })
    site_states: Optional[list[SiteState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    structure_states: Optional[list[BomaInternationalStructureState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    space_states: Optional[list[SpaceState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    id: str = Field(default=..., description="""Canonical identifier; nonblank with no leading or trailing whitespace""", json_schema_extra = { "linkml_meta": {'domain_of': ['Entity']} })
    extras: Optional[Any] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Entity',
                       'InstrumentReference',
...
class BomaInternationalPropertyProfile(PropertyProfile):
    """
    Optional BOMA international-basis office classification profile. Core PHDS does not depend on this profile.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/boma-building-class',
         'slot_usage': {'property_state_snapshots': {'name': 'property_state_snapshots',
                                                     'range': 'BomaInternationalPropertyStateSnapshot'},
                        'structures': {'name': 'structures',
                                       'range': 'BomaInternationalStructure'}},
         'tree_root': True})
    ...
    parcel_lineage: Optional[list[ParcelLineage]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    site: Optional[Site] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    structures: Optional[list[BomaInternationalStructure]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    spaces: Optional[list[Space]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    property_state_snapshots: Optional[list[BomaInternationalPropertyStateSnapshot]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    associations: Optional[list[PropertyAssociation]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    assessments: Optional[list[Assessment]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    tax_bills: Optional[list[TaxBill]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    transfers: Optional[list[Transfer]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
...
BomaMetroOfficeMarketClassification.model_rebuild()
BomaInternationalOfficeMarketClassification.model_rebuild()
BomaMetroCommercialDetails.model_rebuild()
BomaInternationalCommercialDetails.model_rebuild()
BomaMetroStructure.model_rebuild()
BomaMetroStructureState.model_rebuild()
BomaMetroPropertyStateSnapshot.model_rebuild()
BomaMetroPropertyProfile.model_rebuild()
BomaInternationalStructure.model_rebuild()
BomaInternationalStructureState.model_rebuild()
BomaInternationalPropertyStateSnapshot.model_rebuild()
BomaInternationalPropertyProfile.model_rebuild()
