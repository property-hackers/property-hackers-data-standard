// Generated from schema/generated/standards/uad_3_6.schema.json by tools/gen_zod.py. DO NOT EDIT.
...
/**
 */
export const Uad36ConditionCodeSchema = z.intersection(z.enum(["C1", "C2", "C3", "C4", "C5", "C6"]), z.string()).meta({description: "", title: "Uad36ConditionCode"});

export type Uad36ConditionCode = z.infer<typeof Uad36ConditionCodeSchema>;

/**
 */
export const Uad36ConditionSystemSchema = z.intersection(z.enum(["urn:phds:standard:uad:3.6:condition"]), z.string()).meta({description: "", title: "Uad36ConditionSystem"});

export type Uad36ConditionSystem = z.infer<typeof Uad36ConditionSystemSchema>;

/**
 * UAD rating scope. Interior means the appraised dwelling or unit represented by the containing Structure or StructureState; Space-level UAD mapping is not implied.
 */
export const Uad36RatingScopeSchema = z.intersection(z.enum(["overall", "exterior", "interior"]), z.string()).meta({description: "UAD rating scope. Interior means the appraised dwelling or unit represented by the containing Structure or StructureState; Space-level UAD mapping is not implied.", title: "Uad36RatingScope"});

export type Uad36RatingScope = z.infer<typeof Uad36RatingScopeSchema>;

/**
 * UAD 3.6 physical condition rating with an explicit scope.
 */
export const Uad36ConditionRatingSchema = z.strictObject({"code": z.intersection(Uad36ConditionCodeSchema, z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])"))), "description": z.string().nullable().optional(), "display": z.string().nullable().optional(), "scope": Uad36RatingScopeSchema, "system": z.intersection(Uad36ConditionSystemSchema, z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")))}).meta({description: "UAD 3.6 physical condition rating with an explicit scope.", title: "Uad36ConditionRating"});

export type Uad36ConditionRating = z.infer<typeof Uad36ConditionRatingSchema>;

/**
 */
export const Uad36QualityCodeSchema = z.intersection(z.enum(["Q1", "Q2", "Q3", "Q4", "Q5", "Q6"]), z.string()).meta({description: "", title: "Uad36QualityCode"});

export type Uad36QualityCode = z.infer<typeof Uad36QualityCodeSchema>;

/**
 */
export const Uad36QualitySystemSchema = z.intersection(z.enum(["urn:phds:standard:uad:3.6:quality"]), z.string()).meta({description: "", title: "Uad36QualitySystem"});

export type Uad36QualitySystem = z.infer<typeof Uad36QualitySystemSchema>;

/**
 * UAD 3.6 construction quality rating with an explicit scope.
 */
export const Uad36QualityRatingSchema = z.strictObject({"code": z.intersection(Uad36QualityCodeSchema, z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])"))), "description": z.string().nullable().optional(), "display": z.string().nullable().optional(), "scope": Uad36RatingScopeSchema, "system": z.intersection(Uad36QualitySystemSchema, z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")))}).meta({description: "UAD 3.6 construction quality rating with an explicit scope.", title: "Uad36QualityRating"});

export type Uad36QualityRating = z.infer<typeof Uad36QualityRatingSchema>;

/**
 */
export const Uad36StructureStateSchema = z.strictObject({"areas": z.array(AreaMeasureSchema).nullable().optional().meta({description: "Long-tail area kinds; canonical kinds forbidden here (validator-enforced)"}), "basement_area": z.union([AreaSchema, z.null()]).optional(), "basement_finished_area": z.union([AreaSchema, z.null()]).optional(), "commercial": z.union([CommercialDetailsSchema, z.null()]).optional(), "condition_ratings": z.array(Uad36ConditionRatingSchema).nullable().optional().meta({description: "Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair."}), "construction_method": z.string().nullable().optional().meta({description: "site_built | manufactured | modular | container | 3d_printed | ..."}), "construction_status": z.string().nullable().optional().meta({description: "complete | proposed | under_construction"}), "construction_type": z.string().nullable().optional(), "cooling_types": z.array(z.string()).nullable().optional(), "effective_year_built": z.number().int().nullable().optional(), "exterior_wall_type": z.string().nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "features": z.array(z.string()).nullable().optional().meta({description: "Open vocabulary for physical features and amenities"}), "foundation_material": z.string().nullable().optional(), "foundation_type": z.string().nullable().optional(), "garage_area": z.union([AreaSchema, z.null()]).optional(), "gross_area": z.union([AreaSchema, z.null()]).optional(), "ground_floor_area": z.union([AreaSchema, z.null()]).optional(), "heating_fuel_type": z.string().nullable().optional(), "heating_types": z.array(z.string()).nullable().optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "kind": z.string().nullable().optional().meta({description: "building | barn | silo | shed | outbuilding | ... (open)"}), "living_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Finished area intended for human habitation. The measurement method and treatment of above-grade and below-grade space come from the applicable profile or provenance."}), "name": z.string().nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "quality_ratings": z.array(Uad36QualityRatingSchema).nullable().optional().meta({description: "Construction-quality ratings. Semantic validation permits at most one rating for each system and scope pair."}), "renovations": z.array(RenovationSchema).nullable().optional(), "rentable_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Area of occupiable premises allocated to a tenant or available for lease under the stated measurement method."}), "residential": z.union([ResidentialDetailsSchema, z.null()]).optional(), "roof_material_type": z.string().nullable().optional(), "roof_style_type": z.string().nullable().optional(), "sewer_type": z.string().nullable().optional(), "stories": z.number().nullable().optional(), "structure_number": z.string().nullable().optional(), "subject": z.string(), "unit_count": z.number().int().min(1).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional(), "water_type": z.string().nullable().optional(), "year_built": z.number().int().min(1).max(2200).nullable().optional(), "year_built_estimated": z.boolean().nullable().optional()}).meta({description: "", title: "Uad36StructureState"});

export type Uad36StructureState = z.infer<typeof Uad36StructureStateSchema>;

/**
 */
export const Uad36PropertyStateSnapshotSchema = z.strictObject({"as_of_date": z.iso.date(), "basis": z.union([CodeableConceptSchema, z.null()]).optional().meta({description: "at_sale | at_listing | at_lease | inspection | reported | inferred (open vocabulary)"}), "extras": z.union([AnySchema, z.null()]).optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "property": z.string(), "property_state": z.union([PropertyStateSchema, z.null()]).optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "site_states": z.array(SiteStateSchema).nullable().optional(), "space_states": z.array(SpaceStateSchema).nullable().optional(), "structure_states": z.array(Uad36StructureStateSchema).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional()}).meta({description: "", title: "Uad36PropertyStateSnapshot"});

export type Uad36PropertyStateSnapshot = z.infer<typeof Uad36PropertyStateSnapshotSchema>;

/**
 */
export const Uad36StructureSchema = z.strictObject({"areas": z.array(AreaMeasureSchema).nullable().optional().meta({description: "Long-tail area kinds; canonical kinds forbidden here (validator-enforced)"}), "basement_area": z.union([AreaSchema, z.null()]).optional(), "basement_finished_area": z.union([AreaSchema, z.null()]).optional(), "commercial": z.union([CommercialDetailsSchema, z.null()]).optional(), "condition_ratings": z.array(Uad36ConditionRatingSchema).nullable().optional().meta({description: "Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair."}), "construction_method": z.string().nullable().optional().meta({description: "site_built | manufactured | modular | container | 3d_printed | ..."}), "construction_status": z.string().nullable().optional().meta({description: "complete | proposed | under_construction"}), "construction_type": z.string().nullable().optional(), "cooling_types": z.array(z.string()).nullable().optional(), "effective_year_built": z.number().int().nullable().optional(), "exterior_wall_type": z.string().nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "features": z.array(z.string()).nullable().optional().meta({description: "Open vocabulary for physical features and amenities"}), "foundation_material": z.string().nullable().optional(), "foundation_type": z.string().nullable().optional(), "garage_area": z.union([AreaSchema, z.null()]).optional(), "gross_area": z.union([AreaSchema, z.null()]).optional(), "ground_floor_area": z.union([AreaSchema, z.null()]).optional(), "heating_fuel_type": z.string().nullable().optional(), "heating_types": z.array(z.string()).nullable().optional(), "id": z.string().regex(new RegExp("^[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF](?:[\\s\\S]*[^\\u0009-\\u000D\\u0020\\u0085\\u00A0\\u1680\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000\\uFEFF])?(?![\\s\\S])")).meta({description: "Canonical identifier; nonblank with no leading or trailing whitespace"}), "kind": z.string().nullable().optional().meta({description: "building | barn | silo | shed | outbuilding | ... (open)"}), "living_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Finished area intended for human habitation. The measurement method and treatment of above-grade and below-grade space come from the applicable profile or provenance."}), "name": z.string().nullable().optional(), "property": z.string(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "quality_ratings": z.array(Uad36QualityRatingSchema).nullable().optional().meta({description: "Construction-quality ratings. Semantic validation permits at most one rating for each system and scope pair."}), "renovations": z.array(RenovationSchema).nullable().optional(), "rentable_area": z.union([AreaSchema, z.null()]).optional().meta({description: "Area of occupiable premises allocated to a tenant or available for lease under the stated measurement method."}), "residential": z.union([ResidentialDetailsSchema, z.null()]).optional(), "roof_material_type": z.string().nullable().optional(), "roof_style_type": z.string().nullable().optional(), "sewer_type": z.string().nullable().optional(), "stories": z.number().nullable().optional(), "structure_number": z.string().nullable().optional(), "unit_count": z.number().int().min(1).nullable().optional(), "verifications": z.array(VerificationAttributionSchema).nullable().optional(), "water_type": z.string().nullable().optional(), "year_built": z.number().int().min(1).max(2200).nullable().optional(), "year_built_estimated": z.boolean().nullable().optional()}).meta({description: "", title: "Uad36Structure"});

export type Uad36Structure = z.infer<typeof Uad36StructureSchema>;

/**
 * Optional UAD 3.6-constrained PHDS interchange document. Core PHDS does not depend on this profile.
 */
export const Uad36PropertyProfileSchema = z.strictObject({"addresses": z.array(AddressSchema).nullable().optional().meta({description: "Address bundle referenced by property/parties/ownership"}), "artifacts": z.array(SourceArtifactSchema).nullable().optional(), "assessments": z.array(AssessmentSchema).nullable().optional(), "associations": z.array(PropertyAssociationSchema).nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "foreclosure_cases": z.array(ForeclosureCaseSchema).nullable().optional(), "identifiers": z.array(PropertyIdentifierSchema).nullable().optional(), "jurisdictions": z.array(JurisdictionSchema).nullable().optional(), "leases": z.array(LeaseEventSchema).nullable().optional(), "liens": z.array(LienSchema).nullable().optional(), "listings": z.array(ListingSchema).nullable().optional(), "loans": z.array(LoanSchema).nullable().optional(), "operating_statements": z.array(OperatingStatementSchema).nullable().optional(), "ownership": z.array(OwnershipPeriodSchema).nullable().optional(), "parcel_identifiers": z.array(ParcelIdentifierSchema).nullable().optional(), "parcel_lineage": z.array(ParcelLineageSchema).nullable().optional(), "parcels": z.array(ParcelSchema).nullable().optional(), "parties": z.array(PartySchema).nullable().optional(), "permits": z.array(PermitSchema).nullable().optional(), "property": PropertySchema, "property_addresses": z.array(PropertyAddressSchema).nullable().optional(), "property_parcels": z.array(PropertyParcelSchema).nullable().optional(), "property_state_snapshots": z.array(Uad36PropertyStateSnapshotSchema).nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "rent_rolls": z.array(RentRollSchema).nullable().optional(), "sale_evidence": z.array(SaleEvidenceSchema).nullable().optional(), "sales": z.array(SaleEventSchema).nullable().optional(), "site": z.union([SiteSchema, z.null()]).optional(), "spaces": z.array(SpaceSchema).nullable().optional(), "structures": z.array(Uad36StructureSchema).nullable().optional(), "tax_bills": z.array(TaxBillSchema).nullable().optional(), "transfers": z.array(TransferSchema).nullable().optional(), "unit_rents": z.array(UnitRentObservationSchema).nullable().optional(), "valuations": z.array(ValuationSchema).nullable().optional()}).meta({description: "Optional UAD 3.6-constrained PHDS interchange document. Core PHDS does not depend on this profile.", title: "Uad36PropertyProfile"});

export type Uad36PropertyProfile = z.infer<typeof Uad36PropertyProfileSchema>;

/**
 * Optional UAD 3.6-constrained PHDS interchange document. Core PHDS does not depend on this profile.
 */
export const Uad36Schema = z.looseObject({"addresses": z.array(AddressSchema).nullable().optional().meta({description: "Address bundle referenced by property/parties/ownership"}), "artifacts": z.array(SourceArtifactSchema).nullable().optional(), "assessments": z.array(AssessmentSchema).nullable().optional(), "associations": z.array(PropertyAssociationSchema).nullable().optional(), "extras": z.union([AnySchema, z.null()]).optional(), "foreclosure_cases": z.array(ForeclosureCaseSchema).nullable().optional(), "identifiers": z.array(PropertyIdentifierSchema).nullable().optional(), "jurisdictions": z.array(JurisdictionSchema).nullable().optional(), "leases": z.array(LeaseEventSchema).nullable().optional(), "liens": z.array(LienSchema).nullable().optional(), "listings": z.array(ListingSchema).nullable().optional(), "loans": z.array(LoanSchema).nullable().optional(), "operating_statements": z.array(OperatingStatementSchema).nullable().optional(), "ownership": z.array(OwnershipPeriodSchema).nullable().optional(), "parcel_identifiers": z.array(ParcelIdentifierSchema).nullable().optional(), "parcel_lineage": z.array(ParcelLineageSchema).nullable().optional(), "parcels": z.array(ParcelSchema).nullable().optional(), "parties": z.array(PartySchema).nullable().optional(), "permits": z.array(PermitSchema).nullable().optional(), "property": PropertySchema, "property_addresses": z.array(PropertyAddressSchema).nullable().optional(), "property_parcels": z.array(PropertyParcelSchema).nullable().optional(), "property_state_snapshots": z.array(Uad36PropertyStateSnapshotSchema).nullable().optional(), "provenance": z.union([ProvenanceSchema, z.null()]).optional(), "rent_rolls": z.array(RentRollSchema).nullable().optional(), "sale_evidence": z.array(SaleEvidenceSchema).nullable().optional(), "sales": z.array(SaleEventSchema).nullable().optional(), "site": z.union([SiteSchema, z.null()]).optional(), "spaces": z.array(SpaceSchema).nullable().optional(), "structures": z.array(Uad36StructureSchema).nullable().optional(), "tax_bills": z.array(TaxBillSchema).nullable().optional(), "transfers": z.array(TransferSchema).nullable().optional(), "unit_rents": z.array(UnitRentObservationSchema).nullable().optional(), "valuations": z.array(ValuationSchema).nullable().optional()}).meta({$id: "https://example.org/phds/standards/uad-3-6", $schema: "https://json-schema.org/draft/2019-09/schema", description: "Optional UAD 3.6-constrained PHDS interchange document. Core PHDS does not depend on this profile.", metamodel_version: "1.11.0", title: "phds_uad_3_6", version: "0.2.0"});

export type Uad36 = z.infer<typeof Uad36Schema>;
