...
linkml_meta = LinkMLMeta({'default_prefix': 'phds',
     ...
     'source_file': 'schema/standards/uad_3_6.yaml',
...
class Uad36ConditionSystem(str, Enum):
    urnCOLONphdsCOLONstandardCOLONuadCOLON3FULL_STOP6COLONcondition = "urn:phds:standard:uad:3.6:condition"


class Uad36QualitySystem(str, Enum):
    urnCOLONphdsCOLONstandardCOLONuadCOLON3FULL_STOP6COLONquality = "urn:phds:standard:uad:3.6:quality"


class Uad36ConditionCode(str, Enum):
    C1 = "C1"
    C2 = "C2"
    C3 = "C3"
    C4 = "C4"
...
class Uad36QualityCode(str, Enum):
    Q1 = "Q1"
    Q2 = "Q2"
    Q3 = "Q3"
    Q4 = "Q4"
...
class Uad36RatingScope(str, Enum):
    """
    ...
    interior = "interior"
    """
    The appraised dwelling or unit represented by the containing Structure or StructureState. Space-level UAD mapping is not implied.
    """
...
class Uad36ConditionRating(Rating):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/uad-3-6',
         'slot_usage': {'code': {'name': 'code', 'range': 'Uad36ConditionCode'},
                        'scope': {'name': 'scope',
                                  'range': 'Uad36RatingScope',
                                  'required': True},
                        'system': {'name': 'system', 'range': 'Uad36ConditionSystem'}}})

    system: Uad36ConditionSystem = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept', 'Classification', 'Rating']} })
    code: Uad36ConditionCode = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept', 'Classification', 'Rating']} })
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Rating', 'Renovation', 'Permit']} })
    scope: Uad36RatingScope = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Rating']} })
    display: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept']} })
...
class Uad36QualityRating(Rating):
    """
    UAD 3.6 construction quality rating with an explicit scope.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/uad-3-6',
         'slot_usage': {'code': {'name': 'code', 'range': 'Uad36QualityCode'},
                        'scope': {'name': 'scope',
                                  'range': 'Uad36RatingScope',
                                  'required': True},
                        'system': {'name': 'system', 'range': 'Uad36QualitySystem'}}})

    system: Uad36QualitySystem = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept', 'Classification', 'Rating']} })
    code: Uad36QualityCode = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept', 'Classification', 'Rating']} })
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Rating', 'Renovation', 'Permit']} })
    scope: Uad36RatingScope = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Rating']} })
    display: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['CodeableConcept']} })
...
class Uad36Structure(Structure):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/uad-3-6',
         'slot_usage': {'condition_ratings': {'name': 'condition_ratings',
                                              'range': 'Uad36ConditionRating'},
                        'quality_ratings': {'name': 'quality_ratings',
                                            'range': 'Uad36QualityRating'}}})
    ...
    foundation_type: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    foundation_material: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    condition_ratings: Optional[list[Uad36ConditionRating]] = Field(default=None, description="""Physical-condition ratings. Semantic validation permits at most one rating for each system and scope pair.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    quality_ratings: Optional[list[Uad36QualityRating]] = Field(default=None, description="""Construction-quality ratings. Semantic validation permits at most one rating for each system and scope pair.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    heating_types: Optional[list[str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    heating_fuel_type: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    cooling_types: Optional[list[str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
    sewer_type: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['StructureFacts']} })
...
class Uad36StructureState(StructureState):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/uad-3-6',
         'slot_usage': {'condition_ratings': {'name': 'condition_ratings',
                                              'range': 'Uad36ConditionRating'},
                        'quality_ratings': {'name': 'quality_ratings',
...
class Uad36PropertyStateSnapshot(PropertyStateSnapshot):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/uad-3-6',
         'slot_usage': {'structure_states': {'name': 'structure_states',
                                             'range': 'Uad36StructureState'}}})
    ...
    property_state: Optional[PropertyState] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot',
                       ...
                       'Valuation']} })
    site_states: Optional[list[SiteState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    structure_states: Optional[list[Uad36StructureState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    space_states: Optional[list[SpaceState]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyStateSnapshot']} })
    id: str = Field(default=..., description="""Canonical identifier; nonblank with no leading or trailing whitespace""", json_schema_extra = { "linkml_meta": {'domain_of': ['Entity']} })
    extras: Optional[Any] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Entity',
                       'InstrumentReference',
...
class Uad36PropertyProfile(PropertyProfile):
    """
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://example.org/phds/standards/uad-3-6',
         'slot_usage': {'property_state_snapshots': {'name': 'property_state_snapshots',
                                                     'range': 'Uad36PropertyStateSnapshot'},
                        'structures': {'name': 'structures',
                                       'range': 'Uad36Structure'}},
         'tree_root': True})
    ...
    parcel_lineage: Optional[list[ParcelLineage]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    site: Optional[Site] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    structures: Optional[list[Uad36Structure]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    spaces: Optional[list[Space]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    property_state_snapshots: Optional[list[Uad36PropertyStateSnapshot]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    associations: Optional[list[PropertyAssociation]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    assessments: Optional[list[Assessment]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    tax_bills: Optional[list[TaxBill]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
    transfers: Optional[list[Transfer]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['PropertyProfile']} })
...
Uad36StructureState.model_rebuild()
Uad36PropertyStateSnapshot.model_rebuild()
Uad36PropertyProfile.model_rebuild()
